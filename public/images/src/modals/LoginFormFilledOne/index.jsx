...
const LoginFormFilledOneModal = (props) => {
          ...
          <div className="flex flex-col gap-4 items-center justify-start w-full">
            <div className="flex flex-col gap-3 items-start justify-start w-full">
              <div className="bg-white-A700 border border-gray-300 border-solid flex flex-col h-[42px] md:h-auto items-center justify-center md:px-10 px-20 sm:px-5 py-3 rounded-[21px] w-full">
                <div className="flex flex-row gap-2.5 items-center justify-start w-[211px]">
                  <Img
                    className="h-6 w-6"
              ...
              <div className="bg-white-A700 border border-gray-300 border-solid flex flex-col h-[42px] md:h-auto items-center justify-center md:px-10 px-20 sm:px-5 py-3 rounded-[21px] w-full">
                <div className="flex flex-row gap-2.5 items-center justify-start w-[220px]">
              ...
              <div className="bg-white-A700 border border-gray-300 border-solid flex flex-col h-[42px] md:h-auto items-center justify-center md:px-10 px-20 sm:px-5 py-3 rounded-[21px] w-full">
                <div className="flex flex-row gap-2.5 items-center justify-start w-[229px]">
                  <Img
                    className="h-6 w-6"
              ...
              <div className="flex flex-col gap-4 items-center justify-start w-full">
                <div className="flex flex-col items-start justify-start w-full">
                  <Input
                    ...
                    className="!placeholder:text-blue_gray-900_03 !text-blue_gray-900_03 leading-[normal] md:h-auto p-0 sm:h-auto text-[15px] text-left tracking-[0.15px] w-full"
                    wrapClassName="border border-blue_gray-100 border-solid w-full"
                    type="email"
                    shape="round"
                  ></Input>
                </div>
                <div className="flex flex-col font-manrope gap-3 items-end justify-start w-full">
                  <Input
                    name="frameFiftyTwo"
                    placeholder="••••••••••••"
                    className="!placeholder:text-blue_gray-900_03 !text-blue_gray-900_03 leading-[normal] p-0 text-base text-left tracking-[0.16px] w-full"
                    ...
                    size="xs"
                  ></Input>
                  <div className="flex flex-row font-dmsans gap-2.5 items-center justify-start w-full">
                    ...
                    <Text
                      className="common-pointer text-[13px] text-deep_purple-A400 tracking-[0.13px] w-auto"
                      size="txtDMSansRegular13"
                      onClick={() => navigate("/passwordresetenteremailseven")}
                    >
                      <>Mot de passe oublié ?</>
                    </Text>
                  </div>
...
export default LoginFormFilledOneModal;
