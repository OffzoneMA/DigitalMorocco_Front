  ...
  const Menus = [
    ...
    return (
        <div className={`bg-blue_gray-901 flex flex-col min-h-screen p-5 pt-8 ${open ? "w-64" : "w-20"} duration-300 relative`}>
          ...
          <ul className="font-dm-sans-regular text-base leading-6 pt-3 flex-1">
              ...
              Menu && <div key={index} >
                ...
                { Menu.submenu  && submenuOpen && (
                  ...
                  Menu.child.map((el, i) => (
                    <li
                      key={i}
                      className={`font-dm-sans-regular text-base leading-6 ${!open && 'w-fit'}  flex rounded-md py-2 px-4 cursor-pointer hover:bg-blue_gray-902 hover:text-teal-400 text-gray-300 items-center gap-x-2 ml-5 mt-1 `}
                    >
          ...
          <div className="font-dm-sans-regular text-base leading-6">
            <div
