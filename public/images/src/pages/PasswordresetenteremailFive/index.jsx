...
const PasswordresetenteremailFivePage = () => {
    ...
    <>
      <div className="bg-gray-100 flex flex-col font-manrope gap-4 items-center justify-start mx-auto p-[30px] sm:px-5 w-full">
        <div className="flex flex-col items-start justify-center md:px-5 w-auto">
          <PasswordResetEnterEmailTwoButton className="flex flex-col gap-[18px] h-11 md:h-auto items-center justify-center py-[18px] rounded-[22px] w-auto" />
        </div>
        <div className="flex flex-col font-dmsans gap-[42px] items-center justify-start mb-[350px] md:px-5 w-auto sm:w-full">
          ...
          <div className="bg-white-A700 flex flex-col gap-8 items-center justify-start sm:px-5 px-6 py-8 rounded-[12px] shadow-bs1 w-[520px] sm:w-full">
            ...
            <div className="flex flex-col gap-8 items-center justify-start w-full">
                ...
                <div className="flex flex-col items-end justify-start w-full">
                  <div className="flex flex-col gap-2 items-start justify-start w-full">
                    ...
                    <Button
                      ...
                      onClick={() => navigate("/passwordresetenteremailten")}
                      rightIcon={
                        <Img
              ...
              <div className="flex flex-col gap-6 items-center justify-start w-full">
                <PasswordResetEnterEmailFiveButton className="bg-gray-300_01 flex flex-row gap-6 h-[52px] md:h-auto items-center justify-center sm:px-5 px-7 py-[18px] rounded-[26px] w-full" />
...
export default PasswordresetenteremailFivePage;
