              ...
              <div className="flex flex-col gap-4 items-center justify-start w-full">
                ...
                <div className="flex flex-col gap-4 items-center justify-start w-full">
                  ...
                  <div className="flex flex-col gap-2 items-start justify-start w-full">
                    ...
                    <Input
                      name="email"
                      placeholder="wade.warren@gmail.com"
                      className="!placeholder:text-blue_gray-800_01 !text-blue_gray-800_01 leading-[normal] md:h-auto p-0 sm:h-auto text-left text-sm tracking-[0.14px] w-full"
                      wrapClassName="border border-blue_gray-100 border-solid w-full"
                      type="email"
                      shape="round"
                  ...
                  <div className="flex flex-col gap-3 items-end justify-start w-full">
                    <div className="flex flex-col gap-2 items-start justify-start w-full">
                      ...
                      <Input
                        ...
                        placeholder="••••••••••••"
                        className="!placeholder:text-blue_gray-800_01 !text-blue_gray-800_01 leading-[normal] p-0 text-left text-sm tracking-[4.48px] w-full"
...
export default RegisterFilledOnePage;
