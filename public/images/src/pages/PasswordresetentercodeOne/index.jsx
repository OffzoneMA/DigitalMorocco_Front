...
const PasswordresetentercodeOnePage = () => {
  return (
    <>
            ...
            <div className="gap-[42px] grid sm:grid-cols-1 md:grid-cols-2 grid-cols-3 items-start justify-center w-auto md:w-full">
              <div className="border-2 border-indigo-50 border-solid flex flex-col items-start justify-start md:px-10 px-16 sm:px-5 py-[42px] rounded-[16px] w-full">
                <div className="flex flex-col gap-6 items-center justify-start w-auto">
                          ...
                          <div className="h-[127px] m-auto w-full">
                            <div className="h-[127px] m-auto w-full">
                              <div className="absolute h-[127px] inset-[0] justify-center m-auto w-full">
                                ...
                                <Img
                                  className="absolute bottom-[3%] h-[25px] inset-x-[0] mx-auto"
                              ...
                              />
                              <Img
                                className="absolute bottom-[15%] h-[5px] inset-x-[0] mx-auto"
                  ...
                  >
                    Connect, participate in exclusive events, and propel your
                    start-up to success through networking and access to
                    exclusive resources.
                  </Text>
                </div>
              </div>
              <div className="border-2 border-indigo-50 border-solid flex flex-col items-start justify-start md:px-10 px-16 sm:px-5 py-[42px] rounded-[16px] w-full">
                <div className="flex flex-col gap-6 items-center justify-start w-auto">
                  ...
                  <Text
                    ...
                    size="txtDMSansRegular16"
                  >
                    Discover new features, participate in exclusive events, and
                    access privileged resources to enhance your investments.
                  </Text>
                </div>
              </div>
              <div className="border-2 border-indigo-50 border-solid flex flex-col items-start justify-start md:px-10 px-16 sm:px-5 py-[42px] rounded-[16px] w-full">
                <div className="flex flex-col gap-6 items-center justify-start w-auto">
                  ...
                  <Text
                    ...
                    size="txtDMSansRegular16"
                  >
                    Explore innovative features, actively participate in
                    exclusive events, and fully benefit from our privileged
                    partnership.
                  </Text>
                </div>
              </div>
...
export default PasswordresetentercodeOnePage;
