...
const CustomDatePicker = ({setValue , className , onChangeDate}) => {
    ...
    // const button = document.querySelector('.custom-picker > div:first-child > div:first-child >div:first-child > button:nth-child(2)');
...
useEffect(() => {
    // Mettre à jour le texte du bouton lors du premier rendu
    updateButtonText();

    // Écouter les changements du contenu du datepicker
