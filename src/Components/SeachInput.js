...
const SearchInput = ({setValue , className}) => {
  ...
  return (
    <div className={`flex px-3 items-center gap-2 border border-[#D0D5DD] rounded-md ${className }`}>
      <svg
          width="16"
          height="16"
          viewBox="0 0 16 16"
      ...
      <input
        ...
        className="py-2.5 w-full font-manrope text-[14px] placeholder:text-[#98A2B3] text-gray700 font-normal leading-[18.2px] tracking-[0.01em] "
      />
    </div>
  );
};
