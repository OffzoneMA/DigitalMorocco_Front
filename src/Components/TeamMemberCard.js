...
export default function TeamMemberCard( {teamMember,onClick}){
    ...
    return(
                <div onClick={onClick} className="space-y-2 cursor-pointer ">
                    <img src={teamMember?.img} alt="" className="rounded-lg h-[240px] 2xl:h-[300px] 3xl:h-[340px] hover:scale-105 transition-all ease-in-out duration-300 hover:shadow-2xl"/>
