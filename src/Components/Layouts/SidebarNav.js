...
const SidebarNav = () => {
  ...
  const Menus = [
    ...
    (userRole === "member" || validEmailCheck) &&{ title: t('sidebar.event.main'), src: <HiOutlineTicket size={23} className="text-light_blue-100"/>  ,
    ...
    (userRole === "partner" && validEmailCheck) && { title: t('sidebar.sponsoring.main'), src: <PiAtomBold size={23} className="text-light_blue-100"/>  ,
