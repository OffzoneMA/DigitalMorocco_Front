      ...
      >
        <div className="max-h-[97vh] w-full md:w-full">
          <div className="bg-white-A700 border border-gray-500_33 max-h-[97vh] overflow-y-auto border-solid flex flex-col p-6 gap-4 items-center justify-start max-w-screen-sm  rounded-[10px] w-full">
            <div className="w-full flex flex-row items-start"></div>
            <div className="flex flex-col w-full gap-5">
              <Text className="font-dm-sans-bold text-xl leading-[26px] text-[#1F2545] w-full">
                {t("settings.cancelSubscription.title")}
              </Text>
              <Text className="font-dm-sans-regular text-base leading-6 text-[#1D1C21] text-left w-full">
                {t("settings.cancelSubscription.warningMessage", {
                  planName: t(
              ...
              <div className="flex flex-col w-full rounded-[12px] border p-5 border-gray-301 gap-4 ">
                <Text className="font-dm-sans-medium text-[22px] leading-8 text-left  text-[#2575F0]">
              ...
              <div className="flex space-x-3 md:space-x-5 items-start w-full justify-start pt-1 pb-2">
                ...
                >
                  {t("settings.cancelSubscription.keepPlan", {
                    planName:
                      userSubscriptionData?.plan?.forUser?.toLowerCase() ===
                      "investor"
                        ? t(
                ...
                <button
                  ...
                  className={`flex items-center justify-center ml-auto ${
                    sendingOk ? "bg-[#F02A3C] min-w-[180px]" : "bg-[#EF4352]"
                  } hover:bg-[#F02A3C] text-white-A700 h-[44px] py-2 px-[20px] min-w-[209px] font-dm-sans-medium text-base leading-5 tracking-normal rounded-md cursorpointer`}
                >
                  {sendingOk ? (
