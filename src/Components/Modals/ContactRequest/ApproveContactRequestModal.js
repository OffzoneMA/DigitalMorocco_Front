          ...
          <div className="bg-white-A700 border border-gray-500_33 border-solid flex flex-col gap-6 items-center justify-start max-w-screen-sm py-6 rounded-[10px] w-full">
            ...
            <div className="flex flex-col gap-5 w-full max-h-[70vh] px-5 overflow-y-auto">
              ...
              >
                ...
                <SimpleSelect
                  ...
                  placeholder={t(
                    "investment.approveInvestmentRequest.typeOfInvestmentPlaceholder"
                  )}
                  required={typeInvestment === null && sending}
                  content={(option) => {
                    return (
              ...
              >
                ...
                <textarea
                  ...
                  rows={5}
                  placeholder={t(
                    "investment.approveInvestmentRequest.letterPlaceholder"
                  )}
                  style={{
                    scrollbarWidth: "none",
                ...
                ></textarea>
                <p className="font-dm-sans-regular text-sm leading-relaxed text-left text-[#555458]">
            ...
            <div className="flex space-x-3 md:space-x-5 items-end w-full px-5 justify-end">
              ...
              <button
                ...
                } hover:bg-[#235DBD] active:bg-[#224a94] text-white-A700 py-[10px] md:py-[20px] px-[12px] md:px-[20px] font-dm-sans-medium text-base h-[44px] leading-5 tracking-normal rounded-[6px] cursorpointer`}
              >
                {sendingOk ? (
