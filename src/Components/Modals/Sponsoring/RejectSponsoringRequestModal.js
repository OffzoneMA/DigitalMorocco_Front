    ...
    if (selectedRaison !== null) {
      try {
        ...
        await props?.methode({
          ...
          reasonForRejection: selectedRaison,
        });
        openModal();
      } catch (error) {
        setSendingOk(false);
          ...
          <div className="bg-white-A700 border border-gray-500_33 border-solid flex flex-col gap-6 items-center justify-start max-w-screen-sm py-6 rounded-[10px] w-full">
            ...
            <div className="flex flex-col gap-5 w-full max-h-[70vh] px-5 overflow-y-auto">
              ...
              >
                ...
                <SimpleSelect
                  id="reason"
                  options={reasonsForRejectionSponsoring}
                  searchLabel={t("common.searchRaison")}
                  setSelectedOptionVal={setSelectedRaison}
                  placeholder={t(
                    "eventListSponsoring.reject.rejectionReasonPlaceholder"
                  )}
                  required={sending && selectedRaison === null}
                  content={(option) => {
                    return (
