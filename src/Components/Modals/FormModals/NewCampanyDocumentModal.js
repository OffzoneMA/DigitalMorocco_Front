        ...
        <div className="bg-white-A700 border border-gray-500_33 border-solid flex flex-col gap-4 items-center justify-start max-w-screen-sm p-6 md:px-5 rounded-[10px] w-full">
          <div className="border-b border-gray-201 border-solid flex flex-row gap-5 items-start justify-start pb-6 w-full">
            <div className="flex flex-1 flex-col font-DmSans h-full items-start justify-start w-full">
              <h1 className="md:text-lg text-[18px] font-dm-sans-medium leading-7 text-[#1D2939] w-full">
          ...
          <div className="flex flex-col gap-3 w-full max-h-[70vh]">
            <div className="flex flex-col gap-2 items-start justify-start w-full">
              <Text htmlFor="title" className="text-base text-[#1D1C21] w-auto" size="txtDMSansLablel">{t('legal.addNewDocumentSection.documentTitle')}</Text>
              <input
            ...
            <div className="flex flex-col gap-2 items-start justify-start w-full">
              <Text htmlFor="document" className="text-base text-[#1D1C21] w-auto" size="txtDMSansLablel">{t('legal.addNewDocumentSection.uploadDocument')}</Text>
              <div
              ...
              >
                {(preview || documentFile?.name) ? (
                  <div className="flex flex-col items-center text-blue-A400 gap-4 md:flex-1 w-full md:w-full h-auto rounded-md md:h-[206px] py-14">
                    <span className="flex flex-row font-DmSans text-sm text-gray-900_01 font-normal leading-[26px] tracking-normal items-center">
                  ...
                  <div className={`flex flex-col items-center text-blue-A400 gap-4 md:flex-1 w-full md:w-full h-auto rounded-md md:h-[206px] py-14`}
                    ...
                    <input
                      ...
                      id="document"
                    />
                    <span className="font-dm-sans-regular text-sm leading-[26px] tracking-normal">
