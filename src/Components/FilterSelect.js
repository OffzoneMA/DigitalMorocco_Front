...
export default function FilterSelect({title,setItems,items}) {
  return (
          <div className='group relative w-full md:w-fit   font-semibold   cursor-pointer flex items-center justify-center gap-3 px-4 py-2 rounded-full border-2 border-blue-400 text-blue-400'>
            Filter By {title}
