...
const PageTitle = ({title,subtitle,text}) => {
    return (
        <div className="relative flex flex-col items-center justify-center py-32 w-screen  ">
             <div className="absolute left-0 top-0 bg-[url('/public/img/Ornament.png')] bg-no-repeat bg-cover h-[388px] w-[500px] ">
             </div>
             <h1 className="text-sm md:text-sm font-normal mb-2 md:mb-3 text-[#98A2B3] text-center tracking-wider">
            ...
            {text && <p className="text-base font-semibold text-gray700 md:text-sm w-[480px] ">
               {text}
        </p>}
    </div>
    );
