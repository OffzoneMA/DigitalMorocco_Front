                ...
                onDrop={handleDrop}>
                  {(preview || documentFile?.documentName) ? (
                    <div className="flex flex-col items-center text-blue-A400 gap-4 md:flex-1 w-full md:w-full h-auto rounded-md py-14">
                        ...
                        <div className="font-DmSans flex justify-center items-center icon-container bg-white-A700 gap-[6px] text-blue-A400 border border-solid hover:bg-[#235DBD] active:bg-[#224a94] hover:text-[#EDF7FF] border-blue-A400 flex-row h-[46px] items-center py-[7px] px-[12px] rounded-md w-auto min-w-[213px]">
