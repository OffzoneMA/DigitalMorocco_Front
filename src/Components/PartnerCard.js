      ...
      <div className='flex items-center justify-between mt-2'>
        <div
         ...
         className='flex items-center my-1'>
            <a rel='noopener noreferrer' href={partner?.website.startsWith("http") ? partner?.website : "//" + partner?.website} target='_blank' className='text-blue-500 hover:underline font-medium tracking-wider'>
            Visit Website
          </a>
