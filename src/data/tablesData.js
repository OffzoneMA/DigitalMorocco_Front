...
export const historyEventMessages = {
  ...
  event_registered: "Registered for event: {{eventName}}.",
  project_created: "Created project: {{projectName}}.",
  event_attended: "Attended event: {{eventName}}.",
  document_created: "Uploaded document: {{documentName}}.",
  document_uploaded: "Uploaded document: {{documentName}}.",
  legal_document_created: "Uploaded legal document: {{documentName}}.",
  legal_document_updated: "Updated legal document: {{documentName}}.",
  legal_document_deleted: "Deleted legal document: {{documentName}}.",
  project_status_updated: "Project status updated for: {{projectName}}.",
  company_created: "Created a new company: {{companyName}}.",
  subscription_renew: "Subscription renewed successfully.",
  subscription_canceled: "Subscription canceled.",
  subscription_upgraded: "Subscription upgraded to: {{planName}}.",
  new_subscription: "New subscription for plan: {{planName}}.",
  password_changed: "Password changed successfully.",
  account_deleted: "Account deleted successfully.",
  project_updated: "Updated project: {{projectName}}.",
  project_deleted: "Deleted project: {{projectName}}.",
  project_shared: "Shared project: {{projectName}}.",
  employee_added: "Added a new employee to {{companyName}}.",
  employee_removed: "Removed an employee from {{companyName}}.",
  employee_updated: "Updated employee details for {{employeeName}}.",
  company_updated: "Updated company details for: {{companyName}}.",
  document_deleted: "Deleted document: {{documentName}}.",
  document_updated: "Updated document: {{documentName}}.",
  event_ticket_download: "Downloaded ticket for event: {{eventName}}.",
  event_ticket_view: "Viewed ticket for event: {{eventName}}.",
  contact_request_accepted: "Accepted contact request from {{contactName}}.",
  contact_request_rejected: "Rejected contact request from {{contactName}}.",
  sponsor_request_send: "Sent a sponsor request for event: {{eventName}}.",
