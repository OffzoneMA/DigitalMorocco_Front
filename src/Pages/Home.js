    ...
    <div>
     <div className="w-full h-[803px] bg-[#182049] bg-[url(/public/img/Bg.png),_url(/public/img/MorrocoMap.png)] bg-no-repeat bg-right">
      <div className="h-[474px] p-[229px] w-[1424px]">
        <div className="w-[514px] -my-10 -mt-8 -mx-10 space-y-4 ">
         <h2 className="w-[514px] h-[280px] text-left text-5xl/[58px] font-bold text-white tracking-wide leading-normal">Grow your<br/>business through networking and digital solutions!</h2>
