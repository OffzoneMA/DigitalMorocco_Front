...
export default function Home() {
  return (
    ...
    <div>
      <div className="flex items-center justify-center md:items-start md:justify-start px-5 sm:px-20 md:pt-40 md:pl-48 w-full h-screen bg-[#182049] bg-[url(/public/img/Bg.png),_url(/public/img/MorrocoMap.png)]  bg-no-repeat bg-center md:bg-right">
        <div className="flex flex-col items-center justify-center  md:items-start md:justify-start md:max-w-[638px] space-y-4 md:space-y-0 xl:py-10 lg:py-10 md:py-5 ">
          <h2 className=" text-center md:text-left text-3xl md:text-6xl font-bold text-white ">Grow your business through networking and digital solutions!</h2>
