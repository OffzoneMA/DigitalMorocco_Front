                ...
                <div className={`flex flex-col gap-2 items-start justify-start w-full`}>
                  ...
                  <input
                    {...register("contactEmail", {
                      required: { value: true, message: "Company Contact Email is required" },
                      minLength: {
                        value: 2,
                      },
                      maxLength: {
