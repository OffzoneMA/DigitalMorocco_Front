...
const InvestmentRequestHistory = () => {
  ...
  const { data: locationData, isLoading: typeLoading } =
    useGetDistinctProjectFieldsQuery({ field: "stage" });
  ...
  const formatDate = (date) => {
    ...
    return `${dateValues.toLocaleDateString(
      "en-US",
      options
    )} ${dateValues.toLocaleTimeString("en-US", timeOptions)}`;
  };
  ...
  return (
    <>
      <HelmetWrapper
        ...
        description={t(
          "helmet.investment.investmentRequestHistory.description"
        )}
        keywords={t("helmet.investment.investmentRequestHistory.keywords")}
        canonical={`${import.meta.env.VITE_URL}/investmentRequestHistory`}
      />
                  ...
                  {filter && (
                    <>
                      ...
                      <MultipleSelect
                        ...
                        id="status"
                        options={sectorValues?.filter(
                          (item) => item?.toLowerCase() !== "in progress"
                        )}
