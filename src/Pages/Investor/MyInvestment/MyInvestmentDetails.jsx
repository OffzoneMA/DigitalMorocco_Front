...
const MyInvestmentDetails = () => {
  ...
  const { data, error, isLoading, refetch } = useGetContactRequestByIdQuery(
    id,
    {
  ...
  return (
    <>
      <HelmetWrapper
        title={t("helmet.investmentDetails.title", {
          investmentName: project?.name,
        })}
        description={t("helmet.investmentDetails.description", {
          investmentName: project?.name,
        })}
        keywords={t("helmet.investmentDetails.keywords")}
        canonical={`${import.meta.env.VITE_URL}/InvestmentDetails/${id}`}
      />
          ...
          <div className="flex flex-col items-start justify-start px-5 w-full">
            <div className="w-full bg-white-A700 border border-gray-201 rounded-[8px] shadow-tablesbs ">
              ...
              <div className="bg-white-A700 flex md:flex-col flex-row gap-8 items-start border-b border-gray-201 justify-start py-5 w-full">
                <div className="flex gap-y-4 flex-wrap py-2 w-full">
                  ...
                  <div className="flex flex-col items-start justify-start px-[18px] py-2 gap-6 max-w-full min-w-[150px] basis-[150px]	shrink grow">
                    ...
                    {project?.sector ? (
                      <div className="h-[28px] px-[13px] py-3 rounded-[50px] border border-[#c653dd] justify-center items-center gap-1 inline-flex">
                        <div className="text-[#c552dd] text-xs font-dm-sans-regular leading-none tracking-tight">
                          {t(`${project?.sector}`)}
                        </div>
                      </div>
                    ) : (
              ...
              <div className="flex flex-col lg:flex-row xl:flex-row 3xl:flex-row 2xl:flex-row gap-[50px] items-start justify-start px-[18px] py-5 w-full">
                ...
                <div
                  ref={div2Ref}
                  className="flex flex-col items-start gap-[24px] justify-start w-full lg:w-1/3"
                >
                  {project?.logo && (
                    <div className="flex flex-col gap-[10px] pb-[41px] items-start justify-start w-full">
                      ...
                      <div className="h-[270px] w-full max-w-[500px] rounded-[6px] px-3 py-[50px] justify-center border border-[#D0D5DD] items-center gap-1.5 flex">
                        <img
                          src={project?.logo}
                          alt="Logo"
                          className="rounded-[6px] h-[270px] w-auto"
                        />
                      </div>
                    </div>
                  )}
                  <div className="flex flex-row gap-[10px] w-full">
                    ...
                    <div className="flex flex-col gap-[10px] items-start justify-start w-auto">
                      ...
                      <div className="text-[#344053] text-base font-dm-sans-regular leading-relaxed">
                        Startup 8
                      </div>
                    </div>
                  </div>
