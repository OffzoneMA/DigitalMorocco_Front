...
import {
  useGetRecentApprovedContactRequestsQuery,
  useGetLastRecentContactRequestsQuery,
  ...
  return (
    <>
      <HelmetWrapper
        ...
        canonical={`${import.meta.env.VITE_URL}/Dashboard_Investor`}
      />
      <section className="bg-white-A700 flex flex-col gap-8 h-full min-h-screen overflow-auto items-start justify-start pb-14 pt-8 rounded-tl-[40px] w-full">
        <div className="flex flex-col items-start justify-start sm:px-5 px-8 pb-8 w-full">
            ...
            <div className="flex flex-row flex-wrap gap-3 items-center">
              <div className="flex flex-row items-start gap-3 h-full">
                ...
                <div className="flex flex-col gap-0.5">
                  <Text className="text-base md:text-[18px] lg:text-[22px] font-dm-sans-medium leading-7 text-white-A700 tracking-normal w-full">
                    {t("dashboard.upgradeAccount")}
                  </Text>
                  <Text className="text-sm font-dm-sans-regular leading-[26px] tracking-normal  text-white-A700 w-full">
          ...
          <div className="flex flex-wrap gap-8 2xl:gap-10 pt-8 w-full">
            <div
              className="flex flex-col gap-3 items-center rounded-[12px] hover:shadow-dashCard cursorpointer border border-gray-201 py-7 px-[10px] basis-[186px] grow max-w-[400px] xl:max-w-[500px] lg:min-h-[187px] xl:min-h-[200px] 2xl:max-w-[700px] 2xl:min-h-[220px] 3xl:max-w-[700px] 3xl:min-h-[240px]"
            ...
            >
              ...
              {userDetails?.contactCount?.totalRequests > 0 ? (
                <Text className="text-[22px] text-center font-dm-sans-medium leading-[26px] tracking-normal text-[#98A2B3]">
                  {userDetails?.contactCount?.totalRequests < 10
                    ? `0${userDetails?.contactCount?.totalRequests}`
                    : userDetails?.contactCount?.totalRequests}
                </Text>
              ) : (
            ...
            >
              ...
              {userDetails?.contactCount?.inProgressRequests > 0 ? (
                <Text className="text-[22px] text-center font-dm-sans-medium leading-[26px] tracking-normal text-[#98A2B3]">
                  {userDetails?.contactCount?.inProgressRequests < 10
                    ? `0${userDetails?.contactCount?.inProgressRequests}`
                    : userDetails?.contactCount?.inProgressRequests}
                </Text>
              ) : (
                <Text className="text-sm text-center font-dm-sans-regular leading-[26px] tracking-normal text-blue_gray-301">
            ...
            <div className="flex flex-col hover:shadow-dashCard cursorpointer gap-4 items-center rounded-[12px] border border-gray-201 ">
              ...
              >
                ...
                <div className="flex flex-col p-3 items-center ml-2">
                  <Text className=" text-lg font-dm-sans-medium leading-6 text-gray-900_01 tracking-normal w-full">
                ...
                recentProjects.map((item, index) => (
                  ...
                  >
                    <div className="flex flex-row items-center gap-[24px] py-[20px] justify-start w-full">
                      <Text className=" text-lg font-dm-sans-medium leading-8 text-[#101828] tracking-normal capitalize text-left">
                        {item?.project?.name}
                      </Text>
                      <div
                        className={`flex flex-row gap-[6px] bg-green-100 text-[#027A48] items-center py-1 px-[12px] h-7 text-sm font-dm-sans-regular leading-6 rounded-full`}
                      >
                        <svg
                          width="8"
                          height="8"
                ...
                <table className="w-full mb-3">
                  <thead>
                    <tr className="bg-white-A700 text-sm leading-6">
                      ...
                      >
                        {t("investorDashboard.requestTable.projectName")}
                      </th>
                      <th
                        scope="col"
                        className="px-[16px] py-3 text-left text-[#344054] font-DmSans font-medium"
                      >
                        {t(
                          "investorDashboard.requestTable.communicationStatus"
                        )}
                      </th>
                      <th
                        scope="col"
                        className="px-[16px] py-3 text-left text-[#344054] font-DmSans font-medium"
                      >
                        {t("investorDashboard.requestTable.status")}
                      </th>
                    </tr>
                  </thead>
