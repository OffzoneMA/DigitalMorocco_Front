        ...
        <div className="flex flex-col md:flex-row-reverse items-center justify-center md:items-start md:justify-start md:h-screen bg-[#F2F4F7]  ">
           ...
           <div className="">
            ...
            <div className="flex flex-col items-center justify-center md:items-start md:justify-start py-8 3xl:px-40 3xl:py-30 xl:px-20  md:px-10 md:py-10 lg:py-28 lg:pl-20 lg:pr-10 xl:mx-16 xl:py-36 2xl:py-46 xl:space-y-2 sm:p-2 ">
                <h1 className="font-bold text-xs text-gray700 tracking-wider py-3 md:py-2 lg:py-3 3xl:text-4xl 2xl:text-3xl" >WHY JOIN US?</h1>
                <h1 className="font-bold text-2xl sm:text-3xl lg:text-4xl  3xl:text-5xl 2xl:text-4xl text-gray700 leading-normal text-center md:text-left ">Discover a dynamic and innovative business networking platform</h1>
                <p className="font-semibold text-medium sm:text-lg lg:text-xl 3xl:text-4xl 2xl:text-3xl text-gray700 leading-normal text-center tracking-wide  md:text-left lg:py-6 md:py-2  ">Digital Morocco is dedicated to fostering meaningful connections and driving business success.</p>
