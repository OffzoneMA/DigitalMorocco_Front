...
export default function WhoAreWe(){
    return(
        <div className='w-[1424px] h-[700px] pt-[40px] pr-[233px] pb-[100px] pl-[233px]'>
            <div className="w-[958px] h-[224px] py-0 pr-[30px] pl-[290px] space-y-2">
                <p className="font-bold text-xs leading-6 text-gray700 tracking-wider">WHO ARE WE ?</p>
                <p className="w-[500px] h-[192px] text-lg text-gray700 font-medium">Digital Morocco is a community of businesses, institutions, investors, and local and international experts in the digital field, working to develop skills and technologies and to qualify startups and digital projects to meet the challenges of the market and changes in the business environment in Morocco and around the world.</p>
            </div>
            <div className=" w-[958px] h-[486px]">
                <div className="w-[958px] flex items-start pl-[130px]">
