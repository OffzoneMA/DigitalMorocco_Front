                 ...
                 (
                  ...
                  <div className="bg-white-A700  border-b border-gray-200 flex flex-col md:gap-5 flex-1 items-start justify-start w-full overflow-x-auto">
                    ...
                    <tr className="bg-white-A700 text-sm leading-6">
                        <th className="p-3 text-left text-blue_gray-800_01 font-medium">Date</th>
                        ...
                        <th className="p-3 text-left text-blue_gray-800_01 font-medium">Attachment</th>
                        <th className="p-3 text-left text-blue_gray-800_01 font-medium">Notes</th>
                    </tr>
                    </thead>
                    { pageData?.length > 0 ?
                    <tbody className="items-center w-full ">
                    {
                        ...
                        <td className="py-3 px-3 text-gray-600 font-DmSans text-sm font-normal leading-6">{item.investorName}</td>
                        <td className="py-3 px-3 text-gray-600 font-DmSans text-sm font-normal leading-6">{item.communicationStatus}</td>
                        ...
                        <td className="py-3 px-3 text-gray-600 font-DmSans text-sm font-normal leading-6">{item.attachment}</td>
                        <td className="py-3 px-3 text-gray-600 font-DmSans text-sm font-normal leading-6">
                            {item.notes}
                        </td>
