...
import { useGetPartnerActivityHistoriesQuery , useGetHistoryUsersQuery } from "../../../Services/Histoty.Service";
...
const CompaniesHistory = () => {
    ...
    const { data: users, isLoading: isLoadingUsers } = useGetHistoryUsersQuery('partner');
    ...
    const { data, error, isLoading , refetch } = useGetPartnerActivityHistoriesQuery(queryParams);
    ...
    return (
      <>
        <HelmetWrapper
          ...
          canonical={`${process.env.REACT_APP_URL}/CompaniesHistory`}
        />
