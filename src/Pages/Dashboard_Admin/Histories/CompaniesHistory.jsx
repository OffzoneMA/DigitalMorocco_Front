...
const CompaniesHistory = () => {
  ...
  const { data: users, isLoading: isLoadingUsers } =
    useGetHistoryUsersQuery("partner");
  ...
  const { data, error, isLoading, refetch } =
    useGetPartnerActivityHistoriesQuery(queryParams);
  ...
  return (
    <>
      <HelmetWrapper
        title={t("helmet.adminHistory.partners.title")}
        description={t("helmet.adminHistory.partners.description")}
        keywords={t("helmet.adminHistory.partners.keywords")}
        canonical={`${import.meta.env.VITE_URL}/CompaniesHistory`}
      />
