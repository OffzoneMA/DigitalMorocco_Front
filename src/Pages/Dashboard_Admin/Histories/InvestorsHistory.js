...
import { useGetInvestorActivityHistoriesQuery , useGetHistoryUsersQuery } from "../../../Services/Histoty.Service";
...
const InvestorsHistory = () => {
    ...
    const { data: users, isLoading: isLoadingUsers } = useGetHistoryUsersQuery('investor');
    ...
    const { data, error, isLoading , refetch } = useGetInvestorActivityHistoriesQuery(queryParams);
    ...
    return (
      <>
        <HelmetWrapper
          ...
          canonical={`${process.env.REACT_APP_URL}/InvestorsHistory`}
        />
