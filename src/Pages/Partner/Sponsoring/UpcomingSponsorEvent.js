...
const UpcomingSponsorEvent = () => {
  ...
  const { data: events, isFetching: isLoading, refetch } = useGetAllUpcomingEventsSponsorsQuery(queryParams);
                  ...
                  {filter &&
                    (
                      <>
                        ...
                        />
                        <SimpleSelect className="min-w-[120px] max-w-[300px] " id='country' options={distinctValues?.distinctValues || []} 
