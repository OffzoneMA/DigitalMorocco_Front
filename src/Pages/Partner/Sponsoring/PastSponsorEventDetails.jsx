  ...
  return (
    <>
      <HelmetWrapper
        ...
        canonical={`${import.meta.env.VITE_URL}/PastSponsorEventDetails/${id}`}
      />
              ...
              <div className="flex flex-col md:flex-row gap-3 w-full bg-white-A700 border-b border-gray-201 pt-6 pb-9">
                ...
                <div className="flex flex-col gap-3 flex-1">
                  <div className="flex flex-row justify-between items-start gap-3 w-full">
                    <Text className=" text-[24px] font-dm-sans-bold leading-7 text-left text-blue_gray-903 w-full">
                      {event?.eventId?.title ||
                    ...
                    <div className="flex item-center gap-[18px]">
                      <div className="h-[34px] px-3 py-2 bg-[#e5e5e6] rounded-[200px] justify-center items-center gap-2 flex">
                        ...
                        <div className="text-[#a7a6a8] text-sm font-dm-sans-medium">
                          Sponsored
                        </div>
                      </div>
                      {event?.sponsorshipType?.toLowerCase() ===
                        "financial" && (
                        <div className="px-[13px] h-[34px] whitespace-nowrap py-2 rounded-[50px] border border-[#6071f3] justify-center items-center gap-1 w-auto inline-flex">
                          <div className="text-[#444ce6] text-sm font-manrope font-normalleading-none tracking-tight">
                            {t(event?.sponsorshipType)}
                          </div>
                        </div>
                      )}
                      {event?.sponsorshipType?.toLowerCase() ===
                        ...
                        <div className="h-[34px] px-[13px] whitespace-nowrap py-2 rounded-[50px] border border-[#ffc564] justify-center items-center gap-1 inline-flex">
                          <div className="text-[#e49614] text-sm font-manrope font-normal leading-none tracking-tight">
                            {t(event?.sponsorshipType)}
                          </div>
                        </div>
                      )}
                      {event?.sponsorshipType?.toLowerCase() ===
                        ...
                        <div className="h-[34px] px-[13px] whitespace-nowrap py-2 rounded-[50px] border border-[#996fec] justify-center items-center gap-1 inline-flex">
                          <div className="text-[#7f4be7] text-sm font-manrope font-normal leading-none tracking-tight">
                            {t(event?.sponsorshipType)}
                          </div>
                        </div>
                      )}
                      {event?.sponsorshipType?.toLowerCase() ===
                        ...
                        <div className="h-[34px] px-[13px] whitespace-nowrap py-2 rounded-[50px] border border-[#24a561] justify-center items-center gap-1 inline-flex">
                          <div className="text-[#028942] text-sm font-manrope font-normal leading-none tracking-tight">
                            {t(event?.sponsorshipType)}
                          </div>
                        </div>
                      )}
                  ...
                  <div className="flex flex-row gap-3 items-center text-left">
                    ...
                    <Text className="text-gray-801  text-base font-dm-sans-medium leading-6">
                      {formatEventDate(
                    ...
                    <Text className="text-gray-801  text-base font-dm-sans-medium leading-6">
                      {formatEventTime(
                        ...
                        event?.eventId?.startTime
                          ? event?.eventId?.startTime
                          : "",
                        event?.eventId?.endTime ? event?.eventId?.endTime : ""
                      )}
                    </Text>
                  </div>
                  <div className="flex flex-row gap-3 items-center text-left">
                  ...
                  <div className="flex flex-row gap-3 items-center  text-left">
                    ...
                    <Text className="text-gray-801  text-base font-dm-sans-medium leading-6">
                      {formatPrice(event?.eventId?.price, currentLanguage) !==
                      t("Free")
                        ? t("From")
                        : ""}{" "}
                      {formatPrice(event?.eventId?.price, currentLanguage)}
                ...
                <div className="flex flex-col gap-[38px] w-full">
                  ...
                  <div className="flex flex-col md:flex-row justify-between items-start gap-7 w-full">
                    <div className="flex flex-col justify-center items-start w-full md:w-[50%] gap-2.5">
                      ...
                      <Text className=" text-base font-dm-sans-regular leading-relaxed text-left text-gray700 pl-8">
                        {
                          formatEventStartEndDate(event?.eventId, t)
                            ?.formattedStart
                        }
                      </Text>
                    </div>
                  ...
                  <div className="flex flex-col md:flex-row justify-between items-start gap-7 w-full">
                    <div className="flex flex-col justify-center items-start w-full w-full gap-2.5">
                      <div className="flex flex-row gap-3 items-center">
                        <BiMessageAltError
                          size={20}
                          className="text-teal-A700 transform scale-x-[-1]"
                        />
                        <Text className=" text-xs font-dm-sans-bold leading-4 tracking-widest text-left text-blue_gray-301 uppercase">
                      ...
                      <div className="flex flex-col md:flex-row justify-between items-start gap-7 w-full">
                        <div className="flex flex-col justify-center items-start w-full w-full gap-2.5">
                          ...
                          <div className="flex flex-row gap-3 w-full items-center pl-8">
                            {event?.eventId?.attendeesUsers?.length > 0 && (
                              <>
                                {event?.eventId?.attendeesUsers
                                  ?.slice(0, 10)
                                  .map((item, index) => (
                                    <img
                                      key={index}
                                      src={
                                        item?.eventId?.userId?.image ||
                                        userDefaultProfil
                                      }
                                      alt="vector_three"
                                ...
                                {event?.eventId?.attendeesUsers?.length >
                                  10 && (
                  ...
                  <div className="flex flex-col justify-center items-start w-full w-full gap-2.5 pt-3">
                    <div className="flex flex-row gap-3 items-center">
                      ...
                      >
                        <path
                          d="M15.75 15.75H4.65C3.80992 15.75 3.38988 15.75 3.06901 15.5865C2.78677 15.4427 2.5573 15.2132 2.41349 14.931C2.25 14.6101 2.25 14.1901 2.25 13.35V2.25M5.25 7.875V13.125M8.625 4.125V13.125M12 7.875V13.125M15.375 4.125V13.125"
                          stroke="#00CDAE"
                          strokeWidth="1.6"
                          strokeLinecap="round"
                          strokeLinejoin="round"
                      ...
                      <ul className="list-disc leading-6">
                        <li className="leading-6">
                          ...
                          <ul className="list-disc pl-6">
                            <li className="leading-6">
                              {t("On-site and digital brand presence.")}
                            </li>
                            <li className="leading-6">
                              {t(
                                "Logo featured on event website, social media, and marketing materials."
                              )}
                            </li>
                          </ul>
                        </li>
                        <li>
                          ...
                          <ul className="list-disc pl-6">
                            <li className="leading-6">
                              {t("Direct engagement with over 500 attendees.")}
                            </li>
                            <li className="leading-6">
                              {t(
                                "Platform for a keynote speech or presentation."
                              )}
                            </li>
                          </ul>
                        </li>
                        <li>
                          ...
                          <ul className="list-disc pl-6">
                            <li className="leading-6">
                              {t(
                                "Highlighted in brochures, programs, and newsletters."
                              )}
                            </li>
                            <li className="leading-6">
                              {t(
                                "Featured in the event app for attendee navigation."
                              )}
                            </li>
                          </ul>
                        </li>
                  ...
                  <div className="flex flex-col justify-center items-start w-full w-full gap-2.5 pt-3">
                    <div className="flex flex-row gap-3 items-center">
                      ...
                      >
                        <path
                          d="M4.5 4.5L6 3M6 3L4.5 1.5M6 3H4.5C2.84315 3 1.5 4.34315 1.5 6M13.5 13.5L12 15M12 15L13.5 16.5M12 15H13.5C15.1569 15 16.5 13.6569 16.5 12M10.0629 10.0629C10.6496 10.3431 11.3065 10.5 12 10.5C14.4853 10.5 16.5 8.48528 16.5 6C16.5 3.51472 14.4853 1.5 12 1.5C9.51472 1.5 7.5 3.51472 7.5 6C7.5 6.69354 7.65689 7.35043 7.93712 7.93712M10.5 12C10.5 14.4853 8.48528 16.5 6 16.5C3.51472 16.5 1.5 14.4853 1.5 12C1.5 9.51472 3.51472 7.5 6 7.5C8.48528 7.5 10.5 9.51472 10.5 12Z"
                          stroke="#00CDAE"
                          strokeWidth="1.6"
                          strokeLinecap="round"
                          strokeLinejoin="round"
                    ...
                    <div className="flex text-base font-dm-sans-regular leading-normal text-[#344054] pl-8">
                      <ul className="list-disc leading-6">
                        <li className="leading-6">
                          {t(
                            "Sponsorship Cost: $10,000 (Venue Partnership Package)"
                          )}
                          <ul className="list-disc pl-6">
                            <li className="leading-6">
                              ...
                              <ul className="list-disc pl-6">
                                <li className="leading-6">
                                  {t("200+ potential leads generated.")}
                                </li>
                                <li className="leading-6">
                                  {t("50,000+ impressions on social media.")}
                                </li>
                                <li className="leading-6">
                                  {t("Media coverage in post-event articles.")}
                                </li>
                              </ul>
                            </li>
                            <li className="leading-6">
                              ...
                              <ul className="list-disc pl-6">
                                <li className="leading-6">
                                  {t(
                                    "Increased brand recognition and positive brand perception."
                                  )}
                                </li>
                                <li className="leading-6">
                                  {t(
                        ...
                        <li className="leading-6">
                          ...
                          <ul className="list-disc pl-6">
                            <li className="leading-6">
                              {t(
                                "95% rated the event as excellent or very good."
                              )}
                            </li>
                            <li className="leading-6">
                              {t(
                                "Positive feedback on venue facilities and location."
                              )}
                            </li>
                          </ul>
                        </li>
                ...
                <div className="grid lg:grid-cols-5 md:grid-cols-3 grid-cols-2 gap-10 w-full items-center">
                  {sponsors?.length > 0 &&
                    sponsors.map((item, index) => (
                      <img key={index} src={item?.logo} alt="vector_three" />
                    ))}
                </div>
              </div>
            </div>
...
export default PastSponsorEventDetails;
