  ...
  const handleAddAttendee = async () => {
    try {
      ...
      const response = await axios.post(
        `${import.meta.env.VITE_baseURL}/events/${id}/attendeesuser`,
        {
          userId: userData?._id,
          role: userData?.role,
        }
  ...
  return (
    <>
      <HelmetWrapper
        ...
        }/SponsorRequestHistoryDetails/${id}`}
      />
                        ...
                        <>
                          ...
                          {event?.sponsorshipType?.toLowerCase() ===
                            ...
                            <div className="px-[13px] h-[34px] whitespace-nowrap py-2 rounded-[50px] border border-[#6071f3] justify-center items-center gap-1 w-auto inline-flex">
                              <div className="text-[#444ce6] text-sm font-manrope font-normal leading-none tracking-tight">
                          ...
                          <div className="h-[34px] px-3 py-2 bg-[#00cdae] rounded-[200px] justify-center items-center gap-3 flex">
                            <div className="text-white-A700 text-sm font-dm-sans-medium ">
                              {t("Approved")}
                            </div>
                          </div>
                        </>
                      ...
                      {event?.status?.toLowerCase() === "rejected" && (
                        <>
                          ...
                          >
                            ...
                            />
                            <div className="text-white-A700 whitespace-nowrap text-sm font-dm-sans-medium">
                              {t("Approve Now")}
                            </div>
                          </button>
