...
import {
  useGetSponsorsHistoryByPartnerQuery,
  useGetDistinctEventFieldsByPartnerHistoryQuery,
...
const SponsorRequestHistory = () => {
  ...
  const { data: distinctValues, isLoading: distinctsValueLoading } =
    useGetDistinctEventFieldsByPartnerHistoryQuery({ field });
  ...
  const {
    ...
    refetch,
  } = useGetSponsorsHistoryByPartnerQuery(queryParams);
      ...
      >
        <div className="mt-3 px-3 py-6 shadow-sm md:shadow-lg bg-white-A700 min-w-40  fex flex-col rounded-md">
          <div
            ...
            onClick={() =>
              navigate(`/SponsorRequestHistoryDetails/${item?._id}`, {
                state: { event: item },
              })
            }
          >
          ...
          {item?.status?.toLowerCase() === "rejected" && (
            <button
              className="flex flex-row gap-3 pt-5 items-center cursorpointer hover:text-[#35D8BF]"
              onClick={(e) => {
                e.stopPropagation();
  ...
  return (
    <>
      <HelmetWrapper
        ...
        canonical={`${import.meta.env.VITE_URL}/SponsorRequestHistory`}
      />
        ...
        <div className="flex flex-col items-start justify-start sm:px-5 px-8 w-full">
          <div className="border-b border-gray-201 border-solid flex flex-col md:flex-row gap-5 items-start justify-start pb-6 w-full">
            <div className="flex flex-1 flex-col font-DmSans h-full items-start justify-start w-full">
              <PageHeader>{t("eventListSponsoring.requestHistory")}</PageHeader>
            </div>
                ...
                <table className=" w-full">
                  <thead>
                    <tr className="bg-white-A700 text-sm leading-[26px] font-DmSans font-medium h-[44px]">
                      ...
                      >
                        {t("eventListSponsoring.dateTime")}
                      </th>
                      <th
                        scope="col"
                        className="px-[18px] py-3 text-left text-[#344054] font-DmSans font-medium"
                      ...
                      <th
                        ...
                        className="px-[18px] py-3 text-left text-[#344054] font-DmSans font-medium"
                      >
                        {t("eventListSponsoring.eventDate")}
                      </th>
                      <th
                        scope="col"
                        className="px-[18px] py-3 text-left text-[#344054] font-DmSans font-medium"
