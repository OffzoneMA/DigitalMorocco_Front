                  ...
                  <div className="flex flex-col w-full rounded-[12px] border border-[#E4E7EC] gap-[24px] p-4 ">
                    <div className='flex flex-col gap-1 w-full'>
                      <div className="flex flex-row w-full items-center">
                        ...
                        <div className="flex flex-row ml-auto">
                          <button
                            className={`flex justify-center items-center gap-3 w-[150px] h-[44px] p-[18px_30px] rounded-md hover:bg-[#235DBD] active:bg-[#224a94] cursorpointer ${selectedPlan === 'Monthly' ? 'bg-blue-A400 text-white-A700' : 'border border-blue-A400 text-blue-A400 hover:text-[#EDF7FF]'
                              }`}
                          ...
                          <button
                            className={`flex justify-center items-center gap-3 ml-[10px] w-[150px] h-[44px] p-[18px_30px] rounded-md hover:bg-[#235DBD] active:bg-[#224a94] cursorpointer ${selectedPlan === 'Annual' ? 'bg-blue-A400 text-white-A700' : 'border border-blue-A400 text-blue-A400 hover:text-[#EDF7FF]'
                              }`}
                    ...
                    {(selectedPlan === "Annual" && choosedPlan?.price > 0 && choosedPlan?.planType !== "upcoming") ? (
                      <div className="flex flex-row items-center w-full pt-1">
                        <p className="font-dm-sans-medium text-base leading-8 text-left text-gray-500 line-through">
                          {annualPrice}
                        </p>
                        {(choosedPlan?.price > 0 && choosedPlan?.planType !== "upcoming") && 
                        <p className="font-dm-sans-medium text-lg leading-8 text-left text-gray-801 ml-2">
                      ...
                      (choosedPlan?.price > 0 && choosedPlan?.planType !== "upcoming") && 
                      <p className="font-dm-sans-medium text-lg leading-8 pt-1 text-left w-full text-gray-801">
