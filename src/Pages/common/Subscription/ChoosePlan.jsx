...
export default function ChoosePlan() {
  ...
  const userRole =
    userData?.role?.toLowerCase() === "investor" ? "Investor" : "Member";
  ...
  return (
    <>
      <HelmetWrapper
        ...
        canonical={`${import.meta.env.VITE_URL}/ChoosePlan`}
      />
      <section className="bg-white-A700 flex flex-col gap-8 h-full min-h-screen overflow-auto items-start justify-start pb-14 pt-8 rounded-tl-[40px] w-full">
        <div className="flex flex-col items-start justify-start sm:px-5 px-8 w-full">
          ...
          <div className="flex flex-col items-start py-6 w-full h-full gap-3">
            <Text className="text-base font-dm-sans-bold leading-6 text-gray-900_01 w-full">
              {t("subscriptionPlans.accelerateJourney")}
            </Text>
            <Text className="text-[28px] font-dm-sans-bold leading-[42px] text-gray-900_01 w-full">
              ...
              <div className="flex justify-center flex-wrap gap-5 w-full py-5 ">
                {memberPlans?.map((plan) => (
                  <MemberPlan
                    ...
                    buttonText={
                      plan?.price === 0
                        ? t("subscriptionPlans.getStartedIn")
