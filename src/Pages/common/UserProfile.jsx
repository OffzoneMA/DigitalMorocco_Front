...
export default function UserProfile() {
  ...
  const [selectedCountry, setSelectedCountry] = useState(
    userData?.country
      ? allCountries.find((country) => country.name === userData?.country)
      : null
  );
  const [selectedCity, setSelectedCity] = useState(
    userData?.cityState ? userData?.cityState : ""
  );
    ...
    const UserInfo = async () => {
      try {
        const response = await axios.get(
          `${import.meta.env.VITE_baseURL}/users/UserInfo`,
          {
            headers: {
  ...
  const onSubmit1 = async (data) => {
    ...
    try {
      ...
      const response = await axios.put(
        `${import.meta.env.VITE_baseURL}/users/${userId}/updateProfile`,
        formData,
        {
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  const onSubmit2 = async (data) => {
    ...
    try {
      ...
      const response = await axios.put(
        `${import.meta.env.VITE_baseURL}/users/${userId}/changePassword`,
        passwordData,
        {
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  const onSubmit3 = async () => {
    ...
    if (
      ...
      selectedLanguage.label !== userData?.language
    ) {
    ...
    if (
      ...
      selectedRegion.label !== userData?.region
    ) {
    ...
    if (
      ...
      try {
        ...
        const response = await axios.put(
          `${import.meta.env.VITE_baseURL}/users/${userId}/languageRegion`,
          formData,
          {
            headers: {
              Authorization: `Bearer ${token}`,
        ...
        if (response.data.success) {
          ...
          setForm3Sending(false);
          console.error(
            "Error updating language and region:",
  ...
  return (
    <>
      <HelmetWrapper
        ...
        canonical={`${import.meta.env.VITE_URL}/UserProfile`}
      />
        ...
        <div className="flex flex-col items-start justify-start sm:px-5 px-8 w-full">
          <div className="border-b border-gray-201 border-solid flex flex-col md:flex-row gap-5 items-start justify-start pb-6 w-full">
            <div className="flex flex-1 flex-col font-DmSans h-full items-start justify-start w-full">
              <PageHeader>{t("settings.myProfile.title")}</PageHeader>
            </div>
          </div>
          <div className="flex flex-col  md:flex-row items-center md:items-start w-full py-6 gap-8">
            <div className="flex flex-col gap-4 w-[200px] 2xl:w-[240px] 3xl:w-[270px] items-center">
              <div
                className={`relative flex w-full h-[200px] 2xl:h-[240px] 3xl:h-[270px] rounded-full items-center justify-center ${
                  preview || userData?.image ? "" : "bg-light_blue-100"
                }`}
              ...
              >
                ...
                {(preview || userData?.image) && (
                  <div
                    className="absolute  flex items-center justify-center h-[22px] icon-container1"
                    ...
                    {showLogoDropdown && (
                      <div className="absolute top-[100%] right-0 translate-x-[15px] flex flex-col z-10">
                        <div className="flex mt-1 flex-col bg-white-A700 border-[0.5px] border-[#2575F01A] rounded-[8px] p-[16px] shadow-roleCardbs z-10">
                          <div
                            className="w-auto group h-9 py-[5px] px-[6px] justify-start items-center gap-3 inline-flex"
                            onClick={(e) => {
                              e.stopPropagation();
                              handleUploadClick();
                            }}
              ...
              />
              <button
                className="icon-container cursorpointer text-blue-501 hover:bg-[#235DBD] active:bg-[#224a94] hover:text-[#EDF7FF] flex flex-row items-center justify-center p-2 gap-3 rounded-full border-[2px] border-blue-501 w-full"
                onClick={handleUploadClick}
                type="button"
              >
                <svg
            ...
            <div className="flex flex-1 flex-col gap-5">
              ...
              >
                <div className="flex flex-row w-full gap-5">
                  ...
                  >
                    ...
                    <input
                      ...
                      className={`!placeholder:text-blue_gray-301 !text-gray700 leading-[18.2px] font-manrope text-left text-sm tracking-[0.14px] w-full rounded-[6px] px-[12px] py-[10px] h-[40px] border border-[#D0D5DD] ${
                        errors1?.firstName
                ...
                <div className="flex flex-row w-full gap-5">
                  ...
                  >
                    ...
                    <input
                      ...
                      name="phoneNumber"
                      placeholder={t(
                        "settings.myProfile.phoneNumberPlaceholder"
                      )}
                    />
                  </div>
                </div>
                <div className="flex flex-row w-full gap-5">
                  ...
                  >
                    ...
                    <input
                      ...
                      type="text"
                      name="website"
                      placeholder={t("settings.myProfile.websitePlaceholder")}
                    />
                  </div>
                  {/* )} */}
                  <div
                  ...
                  >
                    ...
                    <input
                      ...
                      type="text"
                      name="address"
                      placeholder={t("settings.myProfile.addressPlaceholder")}
                    />
                  </div>
                </div>
                <div className="flex flex-row w-full gap-5">
                  ...
                  >
                    ...
                    <SimpleSelect
                      ...
                      placeholder={t("settings.myProfile.countryPlaceholder")}
                      required={requiredFields1.country}
                      valuekey="name"
                      content={(option) => {
                        return (
                ...
                {isForm1Saved ? (
                  <button
                    disabled
                    className="bg-gray-201 cursorpointer font-dm-sans-medium text-gray500 flex flex-row h-[44px] items-center justify-center min-w-[140px] gap-3 mr-auto py-2 px-7 rounded-md w-auto"
                    type="submit"
                  >
                    <SlCheck size={20} />
                    <span className="text-base text-gray500">
                      {t("common.saved")}
                    </span>
                  </button>
                ) : form1Sending ? (
              ...
              >
                ...
                >
                  ...
                  <div className="relative w-full">
                    <input
                      ...
                      className={`${
                        !showCurrentPassword ? "tracking-[0.32em]" : ""
                      } placeholder:tracking-normal bg-white-A700 w-full border border-solid ${
                        errors2?.currentPassword
                          ? "border-errorColor shadow-inputBsError "
                          : "border-borderColor"
                      } rounded-[6px] px-[12px] py-[10px] ${
                        errors2?.currentPassword
                          ? "focus:border-errorColor"
                          : "focus:border-focusColor focus:shadow-inputBs"
                      } placeholder:text-placehColor font-dm-sans-regular placeholder:text-[14px] text-[14px] ${
                        errors2?.currentPassword
                          ? "text-errorColor"
                          : "text-[#1d2939]"
                      }`}
                      ...
                      placeholder={t(
                        "settings.myProfile.currentPasswordPlaceholder"
                      )}
                    />
                    ...
                    >
                      {showCurrentPassword ? (
                        ...
                        >
                          <path
                            d="M14.1144 4.63848C14.724 4.54835 15.3529 4.5 16.0006 4.5C23.6581 4.5 28.6829 11.2573 30.371 13.9302C30.5754 14.2538 30.6775 14.4155 30.7347 14.665C30.7776 14.8524 30.7776 15.148 30.7346 15.3354C30.6774 15.5849 30.5745 15.7477 30.3688 16.0734C29.919 16.7852 29.2333 17.7857 28.3247 18.8707M8.08648 7.07256C4.84337 9.27255 2.64168 12.3291 1.63166 13.9279C1.42643 14.2528 1.32381 14.4152 1.26661 14.6647C1.22365 14.8521 1.22363 15.1477 1.26657 15.335C1.32374 15.5845 1.4259 15.7463 1.6302 16.0698C3.31831 18.7427 8.34312 25.5 16.0006 25.5C19.0882 25.5 21.7478 24.4014 23.9332 22.9149M2.50062 1.5L29.5006 28.5M12.8186 11.818C12.0043 12.6324 11.5006 13.7574 11.5006 15C11.5006 17.4853 13.5153 19.5 16.0006 19.5C17.2433 19.5 18.3683 18.9963 19.1826 18.182"
                            stroke="#1D2939"
                            strokeWidth="3"
                            strokeLinecap="round"
                            strokeLinejoin="round"
                ...
                >
                  <Text
                    ...
                    size="txtDMSansLablel"
                  >
                    {t("settings.myProfile.newPassword")}{" "}
                  </Text>
                  <div className="relative w-full">
                    <input
                      ...
                      name="newPassword"
                      placeholder={t(
                        "settings.myProfile.newPasswordPlaceholder"
                      )}
                    />
                  ...
                  {(errors2?.newPassword ||
                    ...
                    newPasswordValidation.hasDigit) &&
                    getValues2("newPassword") !== "• • • • • • • •" && (
                      <>
                        <span className="">
                          <ul
                          ...
                          >
                            <li
                              className={`text-[#555458] items-center justify-start text-xs flex ${
                            ...
                            >
                              ...
                              getValues2("newPassword") == "" ? (
                                ...
                                >
                                  <path
                                    d="M6 0C2.6865 0 0 2.6865 0 6C0 9.3135 2.6865 12 6 12C9.3135 12 12 9.3135 12 6C12 2.6865 9.3135 0 6 0ZM5.07 8.76863L2.30925 6.0075L3.36975 4.947L5.06962 6.64762L8.676 3.04125L9.7365 4.10175L5.07 8.76863Z"
                                    fill="#D0D5DD"
                                  />
                                </svg>
                              ) : (
                            ...
                            <li
                              className={`text-[#555458] text-xs justify-start items-center flex ${
                                errors2.newPassword?.type === "hasLowerCase"
                                  ? "error"
                                  : "valid"
                              }`}
                            >
                            ...
                            <li
                              className={`text-[#555458] text-xs items-center justify-start flex ${
                                errors2.newPassword?.type === "hasUpperCase"
                                  ? "error"
                                  : "valid"
                              }`}
                            >
                            ...
                            <li
                              className={`text-[#555458] text-xs items-center justify-start flex ${
                                errors2.newPassword?.type === "hasSpecialChar"
                                  ? "error"
                                  : "valid"
                              }`}
                            >
                            ...
                            <li
                              className={`text-[#555458] text-xs items-center justify-start flex ${
                                errors2.newPassword?.type === "hasDigit"
                                  ? "error"
                                  : "valid"
                              }`}
                            >
                              ...
                              <span className="ml-1">{t("signup.number")}</span>
                            </li>
                          </ul>
                        </span>
                ...
                >
                  <Text
                    ...
                    size="txtDMSansLablel"
                  >
                    {t("settings.myProfile.confirmNewPassword")}{" "}
                  </Text>
                  <div className="relative w-full">
                    <input
                      ...
                      style={{ appearance: "none" }}
                      className={`${
                        !showPasswordConfirm ? "tracking-[0.32em]" : ""
                      } placeholder:tracking-normal bg-white-A700 w-full border border-solid ${
                      ...
                      placeholder={t(
                        "settings.myProfile.confirmNewPasswordPlaceholder"
                      )}
                    />
              ...
              >
                ...
                <div
                  className={`flex flex-row gap-14 items-center justify-start  w-full`}
                >
                  <Text
                    className={`text-base text-gray-901 ${
                      currentLanguage === "fr" ? "w-[170px]" : "w-[130px]"
                    }`}
                    size="txtDMSansLablel"
                  >
                    {t("settings.myProfile.selectLanguage")}{" "}
                  </Text>
                  <SimpleSelect
                    className="max-w-[40%]"
                    id="language"
                    options={languages}
                    searchLabel={t("settings.myProfile.searchLanguage")}
                    setSelectedOptionVal={setSelectedLanguage}
                    selectedOptionsDfault={
                      userData?.language
                        ? languages.find(
                            (lang) => lang.label === userData.language
                          )
                        : ""
                    }
                    required={requiredFields3.language}
                ...
                >
                  <Text
                    ...
                    size="txtDMSansLablel"
                  >
                    {t("settings.myProfile.selectRegion")}
                  </Text>
                  <SimpleSelect
                    className="max-w-[40%]"
                    id="region"
                    options={regions}
                    searchLabel={t("settings.myProfile.searchRegion")}
                    setSelectedOptionVal={setSelectedRegion}
                    selectedOptionsDfault={
                      userData?.region
                        ? regions.find(
                            (region) => region.label === userData.region
                          )
                        : ""
                    }
                    placeholder={t(
                      "settings.myProfile.selectRegionPlaceholder"
                    )}
                    required={requiredFields3.region}
                    valuekey="label"
                    content={(option) => {
                      return (
                        <div className="flex py-2 items-center  w-full">
              ...
              <div className="flex w-full flex-col gap-5 border-b border-gray-201 border-solid pb-8">
                ...
                <button
                  className="bg-blue-A400 hover:bg-[#235DBD] active:bg-[#224a94] text-base text-white-A700 flex flex-row h-[44px] items-center justify-center min-w-[178px] mr-auto py-2 px-5 rounded-md w-auto cursorpointer"
