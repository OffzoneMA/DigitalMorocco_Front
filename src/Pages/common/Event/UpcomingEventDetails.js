          ...
          <div className="flex flex-col items-start justify-start sm:px-5 px-8 w-full">
            ...
            <div className="flex flex-col items-start justify-start w-full">
                ...
                <div className="flex flex-col gap-7 w-full">
                  ...
                  <div className="flex flex-col md:flex-row justify-between items-start gap-7 w-full">
                    <div className="flex flex-col justify-center items-start w-full md:w-[50%] gap-2.5">
                      ...
                      <time
                      dateTime={formatEventStartEndDate(event, t)?.dateTimeStart}
                    ...
                    <div className="flex flex-col justify-center items-start flex-1 gap-2.5">
                      ...
                      <div className="relative">
                        <time
                          dateTime={formatEventStartEndDate(event, t)?.dateTimeEnd}
                          className=" text-base font-dm-sans-regular leading-relaxed text-left text-gray700 pl-8">
              ...
              <div className="flex flex-col gap-6 pt-9 w-full pb-8">
                <h2 className=" text-lg font-semibold leading-8 text-left text-blue_gray-903">
                ...
                {/* <div className="relative overflow-hidden w-full gap-10 flex flex-col">
                    <div className="flex gap-6 sponsor-marquee group-hover:pause">
                      {[...sponsors, ...sponsors].map((item, index) => (
                        <div
                          key={`row1-${index}`}
                          className="group-item relative flex items-center justify-center transition-all duration-500 hover:scale-110 hover:rotate-1 min-w-[200px]"
                        >
                          <img
                            src={item?.logo}
                            alt={`Sponsor ${index + 1}`}
                            className="max-h-10 w-auto object-contain opacity-70 group-item-hover:opacity-100 transition-all duration-300 group-item-hover:scale-110"
                          />
                        </div>
                      ))}
                    </div>
                    <div className="flex gap-6 sponsor-marquee reverse group-hover:pause">
                      {[...sponsors, ...sponsors].map((item, index) => (
                        <div
                          key={`row2-${index}`}
                          className="group-item relative flex items-center justify-center transition-all duration-500 hover:scale-110 hover:rotate-1 min-w-[200px]"
