...
const UpcomingEventDetails = () => {
  ...
  return (
    <>
      <HelmetWrapper
        title={t(`helmet.${event?.status}EventDetails.title`, {
          eventName: event?.title,
        })}
        description={t(`helmet.${event?.status}EventDetails.description`, {
        ...
        canonical={
          event?.status === "past"
            ? `${import.meta.env.VITE_URL}/PastEventDetails/${id}`
            : `${import.meta.env.VITE_URL}/UpcomingEventDetails/${id}`
        }
      />
              ...
              <div className="flex flex-col md:flex-row gap-3 w-full bg-white-A700 border-b border-gray-201 pt-6 pb-9">
                ...
                <div className="flex flex-col gap-3 flex-1">
                  <div className="flex flex-row justify-between items-start gap-3 w-full">
                    <Text className="h-[38px] text-[24px] font-dm-sans-bold leading-7 text-left text-blue_gray-903 w-full">
                      {event?.title ||
                    ...
                    {event?.status === "upcoming" &&
                      !event?.userParticipated && (
                        <button
                          ...
                          className={`${
                            bying ? "bg-[#235DBD]" : "bg-blue-A400"
                          } hover:bg-[#235DBD] active:bg-[#224a94] text-white-A700 flex flex-row h-[38px] items-center justify-center px-4 py-2 rounded-md min-w-[101px] cursorpointer`}
                          type="button"
                        >
                          {bying ? (
                            ...
                            <span
                              ...
                              className="text-sm  font-dm-sans-medium leading-[18.23px]"
                            >
                  ...
                  <div className="flex flex-row gap-3 items-center text-left">
                    ...
                    <Text className="text-gray-801  text-base font-dm-sans-medium leading-[22px]">
                                ...
                                {event?.attendeesUsers
                                  ...
                                  .map((item, index) => (
                                    <img
                                      key={index}
                                      src={
                                        item?.userId?.image || userDefaultProfil
                                      }
                                      alt="vector_three"
