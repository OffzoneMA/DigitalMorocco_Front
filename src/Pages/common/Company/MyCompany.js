...
const MyCompany = () => {
    ...
    try {
      ...
      if (isFormValid && isValid) {
        ...
        const response = await fetch(
          `${process.env.REACT_APP_baseURL}/members/companies`,
          {
            method: "POST",
            headers: {
  ...
  const handleRemoveLogo = async () => {
    ...
    if (!imgFile && userDetails?.logo) {
      const response = await fetch(
        `${process.env.REACT_APP_baseURL}/members/deleteLogo`,
        {
          method: "DELETE",
          headers: {
            Authorization: `Bearer ${token}`,
              ...
              <div className="flex flex-1 md:miw-w-[300px] flex-col gap-6 items-start justify-start w-full">
                ...
                >
                  ...
                  <SimpleSelect
                    ...
                    placeholder={t("myCompany.selectCountry")}
                    valuekey="name"
                ...
                >
                  ...
                  <SimpleSelect
                    ...
                    placeholder={t("myCompany.selectSector")}
                    selectedOptionsDfault={selectedSector}
                ...
                >
                  <Text
                    className="text-base text-[#1D1C21] w-auto"
                    size="txtDMSansLablel"
                    htmlFor="taxIdentfier"
                  >
                    {t("myCompany.taxIdentifierNumber")}
                  </Text>
                  <input
                    {...register("taxIdentfier", {
                      required: {
                        value: false,
                        message: "Company taxIdentfier is required",
                      },
                    })}
                    className={`!placeholder:text-blue_gray-301 !text-gray700 leading-[18.2px] font-manrope text-left text-sm tracking-[0.14px] w-full rounded-[6px] px-[12px] py-[10px] h-[40px] border border-[#D0D5DD] ${
                      errors?.taxIdentfier
                ...
                >
                  <Text
                    className="text-base text-[#1D1C21] w-auto"
                    size="txtDMSansLablel"
                    htmlFor="corporateIdentfier"
                  >
                    {t("myCompany.corporateIdentifierNumber")}
                  </Text>
                  <input
                    {...register("corporateIdentfier", {
                      required: {
                        value: false,
                        message: "Company corporateIdentfier is required",
                      },
                    })}
                    className={`!placeholder:text-blue_gray-301 !text-gray700 leading-[18.2px] font-manrope text-left text-sm tracking-[0.14px] w-full rounded-[6px] px-[12px] py-[10px] h-[40px] border border-[#D0D5DD] ${
                      errors?.corporateIdentfier
                        ? "border-errorColor shadow-inputBsError focus:border-errorColor"
                        : "border-[#D0D5DD] focus:border-focusColor focus:shadow-inputBs"
                    }`}
                    type="text"
                    name="corporateIdentfier"
                    id="corporateIdentfier"
                      ...
                      <>
                        <div className="flex flex-col text-blue-500 gap-1.5 items-center justify-center px-3 rounded-md w-full">
                          ...
                          <div className="flex flex-col items-start justify-start w-auto">
                            <span className="text-[13px] font-dm-sans-regular text-base text-center leading-6 tracking-normal w-auto">
                              {isDragging
                                ? "Drop Your logo here"
                                : t("myCompany.uploadLogo")}
                            </span>
                          </div>
                        </div>
                        <input
