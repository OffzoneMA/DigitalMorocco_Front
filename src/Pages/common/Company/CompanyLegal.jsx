...
const CompanyLegal = () => {
  ...
  const fetchLegalDocuments = async () => {
    try {
      ...
      const response = await axios.get(
        `${import.meta.env.VITE_baseURL}/legal-documents/byuser`,
        {
          headers: {
  ...
  const handleDelete = async () => {
    try {
      const token = sessionStorage.getItem("userToken");
      await axios.delete(
        `${import.meta.env.VITE_baseURL}/legal-documents/${documentId}`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
  ...
  const handleAddDocument = async (formData) => {
    try {
      ...
      const response = await axios.post(
        `${import.meta.env.VITE_baseURL}/legal-documents`,
        formData,
        {
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  return (
    <>
      <HelmetWrapper
        ...
        canonical={`${import.meta.env.VITE_URL}/CompanyLegal`}
      />
