...
const Documents = () => {
  ...
  const {
    ...
    refetch,
  } = useGetDocumentsForUserQuery({ page: cur, pageSize: itemsPerPage });
  ...
  return (
    <>
      <HelmetWrapper
        ...
        canonical={`${import.meta.env.VITE_URL}/Document`}
      />
      <section className="bg-white-A700 flex flex-col gap-8 h-full min-h-screen overflow-auto items-start justify-start pb-14 pt-8 rounded-tl-[40px] w-full">
        <div className="flex flex-col items-start justify-start sm:px-5 px-8 w-full">
          <div className="border-b border-gray-201 border-solid flex flex-col md:flex-row gap-5 items-start justify-start pb-6 w-full">
            <div className="flex flex-1 flex-col font-DmSans h-full items-start justify-start w-full">
              <PageHeader>{t("document.title")}</PageHeader>
            </div>
        ...
        <div className="flex flex-col items-start justify-start sm:px-5 px-8 w-full">
          <div className="w-full bg-white-A700 border border-gray-201 rounded-[8px] shadow-tablesbs ">
            <div className="flex flex-row flex-wrap items-center text-gray-500 border-b border-gray-201 rounded-t-lg bg-white-A700 py-[19.5px] px-5">
              <TableTitle>{t("document.myDocument")}</TableTitle>
              <button
                  ...
                  <tbody className="items-center w-full ">
                    {pageData.map((item, index) => (
                      ...
                      >
                        ...
                        <td className="px-[18px] py-4 text-gray500 font-dm-sans-regular capitalize text-sm leading-6">
                          {item?.shareWithUsersNames || "-"}
                        </td>
        ...
        <DeleteModal
          ...
          title={t("document.deleteDocumentConfirmation.title")}
