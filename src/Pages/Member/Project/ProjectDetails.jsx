...
const ProjectDetails = () => {
  ...
  const [addMilestoneToProject, { isSuccess, isError }] =
    useAddMilestoneToProjectMutation();
  ...
  const { data, error, isLoading, refetch } = useGetProjectByIdQuery(
    projectId,
    { refetchOnMountOrArgChange: true, skip: Boolean(!projectId) }
  );
  ...
  const addMilestoneToProjectFonction = async (data) => {
    const response = await addMilestoneToProject({
      projectId: projectId,
      milestoneData: data,
    });
    refetch();
  ...
  return (
    <>
      <HelmetWrapper
        ...
        canonical={`${import.meta.env.VITE_URL}/Projectdetails/${projectId}`}
      />
      {isLoading ? (
            ...
            <div className="flex flex-col items-start justify-start px-5 w-full">
              <div className="w-full bg-white-A700 border border-gray-201 rounded-[8px] shadow-tablesbs ">
                  ...
                  <div className="flex flex-wrap gap-3 items-center ">
                    ...
                    >
                      ...
                      <span className="hidden md:inline-block">
                        {t("projects.projectDetails.shareToInvestor")}
                      </span>
                    </button>
                    <button
                    ...
                    >
                      ...
                      <span className="hidden md:inline-block">
                        {t("projects.projectDetails.deleteProject")}
                      </span>
                    </button>
                    <button
                    ...
                    >
                      ...
                      <span className="hidden md:inline-block">
                        {t("projects.projectDetails.editProject")}
                      </span>
                    </button>
                  </div>
                </div>
                  ...
                  <div className="flex  gap-y-4 flex-wrap py-2 w-full">
                    <div className="flex flex-col items-start justify-start gap-6 px-[18px] py-2 max-w-full min-w-[150px] basis-[150px]	shrink grow">
                      <div className="bg-white-A700 flex flex-col items-start justify-start w-full">
                        <Text
                          className="text-[#98A2B3] text-xs tracking-[1.68px] uppercase font-dm-sans-bold"
                      ...
                      <div className="bg-white-A700 flex flex-col items-start justify-start w-full">
                        <Text
                          className="md:text-[22px] text-gray700 text-base font-dm-sans-medium"
                    ...
                    <div className="flex flex-col items-start justify-start px-[18px] py-2 gap-6 max-w-full min-w-[150px] basis-[150px]	shrink grow">
                      ...
                      <div className="flex flex-row items-start justify-start w-full">
                        <div
                          className={`flex items-center justify-center text-center w-auto px-[10px] py-[5px] h-[28px] gap-[6px] font-inter text-sm font-medium leading-[20px] rounded-full ${
                            project?.status === "Active"
                              ? "bg-green-100 text-green-700"
                              : project?.status === "In Progress"
                              ? "bg-light_blue-100 text-blue-501"
                              : project?.status === "Stand by"
                              ? "bg-gray-201 text-blue_gray-700"
                              : "bg-green-100 text-green-700"
                          }`}
                          style={{ whiteSpace: "nowrap" }}
                        >
                    ...
                    <div className="flex flex-col items-start justify-start px-[18px] py-2 gap-6 max-w-full min-w-[150px] basis-[150px]	shrink grow">
                      ...
                      <div className="flex flex-row items-start justify-start w-full">
                        <div
                          className={`flex items-center justify-center text-center w-auto px-[10px] py-[4px] h-[28px] gap-[6px] font-inter text-sm font-medium leading-[20px] rounded-full ${
                            project?.visbility?.toLowerCase() === "public"
                              ? "bg-green-100 text-green-700"
                              : project?.visbility?.toLowerCase() === "private"
                              ? "bg-[#FFEEEA] text-[#FF5733]"
                              : "bg-green-100 text-green-700"
                          }`}
                          style={{
                            whiteSpace: "nowrap",
                ...
                <div className="flex flex-col lg:flex-row xl:flex-row 3xl:flex-row 2xl:flex-row gap-[50px] items-start justify-start px-[18px] py-5 w-full">
                    ...
                    <div className="flex flex-col items-start justify-start pb-4 w-full">
                      <div className="flex flex-row gap-1 items-center justify-between w-full">
                        ...
                        <button
                          ...
                          type="button"
                        >
                          <span className="cursorpointer font-medium leading-[normal] text-center text-xs">
                            {t("projects.projectDetails.addNewMilestone")}
                          </span>
                        </button>
                      </div>
                      <div className="flex flex-col items-start justify-start w-full">
                      ...
                      <div className="flex flex-row gap-1 items-center justify-between w-full">
                        ...
                        <div className="relative w-[50%] min-w-[120px] max-w-[350px]">
                          <input
                            ...
                            name="search"
                            placeholder={t(
                              "projects.createNewProject.searchMember"
                            )}
                            value={searchValue}
                  ...
                  <div
                    ref={dividerRef}
                    className="bg-gray-201 lg:h-[${maxDivHeight}] h-px w-full lg:w-px"
                  />
                  {/*Fin Divider */}
                  <div
                    ref={div2Ref}
                    className="flex flex-col items-start justify-start w-full lg:w-1/3"
                  >
                    <div className="flex flex-col items-center justify-start w-auto">
                      <Text
                        className="text-[#98A2B3] text-xs tracking-[1.68px] uppercase w-auto"
      ...
      <NewMilestoneModal
        isOpen={isModalOpenMilestone}
        onRequestClose={closeModalMilestone}
        rowData={project}
        method={addMilestoneToProjectFonction}
      />

      <ShareToInvestorModal
        isOpen={isModalOpen}
        projectId={projectId}
        project={project}
