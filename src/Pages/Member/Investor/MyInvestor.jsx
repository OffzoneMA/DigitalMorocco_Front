...
import {
  useGetDistinctInvestorFieldValuesQuery,
  useGetInvestorsForMemberQuery,
...
const MyInvestors = () => {
  ...
  const {
    ...
    isFetching: loading,
    refetch,
  } = useGetInvestorsForMemberQuery(queryParams);
  const {
    data: locations0,
    isLoading: locationLoading,
    error: locationError,
  } = useGetDistinctInvestorFieldValuesQuery("location");
  const { data: locations1 } =
    useGetDistinctInvestorFieldValuesQuery("country");
  const { data: industriesData, isLoading: industryLoading } =
    useGetDistinctInvestorFieldValuesQuery("PreferredInvestmentIndustry");
  const { data: investorTypes, isLoading: typeLoading } =
    useGetDistinctInvestorFieldValuesQuery("type");
  ...
  return (
    <>
      <HelmetWrapper
        ...
        canonical={`${import.meta.env.VITE_URL}/MyInvestors`}
      />
                  ...
                  {filter && (
                    <>
                      ...
                      <MultipleSelect
                        ...
                        id="investor"
                        options={investorTypes?.distinctValues || []}
                      ...
                      <SimpleSelect
                        ...
                        id="country"
                        options={locations?.distinctValues || []}
                      ...
                      <MultipleSelect
                        ...
                        id="investor"
                        options={industriesData?.distinctValues || []}
                      ...
                      <tbody className="items-center w-full ">
                        {pageData.map((item, index) => (
                          <tr
                            ...
                            onClick={() =>
                              navigate(`/MyInvestorDetails/${item?._id}`, {
                                state: { investor: item },
                              })
                            }
                          >
