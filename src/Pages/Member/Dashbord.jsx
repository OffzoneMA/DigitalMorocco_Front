  ...
  return (
    <>
      <HelmetWrapper
        ...
        canonical={`${import.meta.env.VITE_URL}/Dashboard`}
      />
                ...
                <table className="w-full mb-3">
                  <thead>
                    <tr className="bg-white-A700 text-sm leading-6">
                      ...
                      >
                        {t("dashboard.investorTable.investorName")}
                      </th>
                      <th
                        scope="col"
                        className="px-[16px] py-3 text-left text-[#344054] font-DmSans font-medium"
                      >
                        {t("dashboard.investorTable.communicationStatus")}
                      </th>
                      <th
                        scope="col"
                        className="px-[16px] py-3 text-left text-[#344054] font-DmSans font-medium"
                      >
                        {t("dashboard.investorTable.status")}
                      </th>
                    </tr>
                  </thead>
                    ...
                    {!contactReqsLoading && Requestdata?.length > 0
                      ? Requestdata.map((item, index) => (
                          <tr
                            ...
                            onClick={() =>
                              navigate(
                                `/InvestorDetails/${item?.investor?._id}`
                              )
                            }
                          >
                                ...
                                <div className="flex px-3 py-4 items-center gap-2">
                                  {item?.logo ? (
                                    ...
                                    <div className="flex items-center justify-center rounded-full h-9 w-9 bg-[#EDF7FF] p-2">
                                      <img
                                        src={item?.image || userdefaultProfile}
                                        alt=""
                                        className=""
                                      />
                                    </div>
