  ...
  return (
    <>
      <HelmetWrapper
        ...
        canonical={`${process.env.REACT_APP_URL}/PasswordResetSucces`}
      />
      <section className="bg-gray-100 flex flex-col font-DmSans items-center min-h-screen justify-start mx-auto md:py-[60px] md:px-10 px-3 py-[30px] overflow-y-auto w-full">
        <div className="flex flex-col gap-[42px] items-center justify-start mb-[213px] w-full">
          ...
          <div className="bg-white-A700 flex flex-col gap-9 items-center justify-start px-6 py-[42px] rounded-[12px] shadow-formbs max-w-[520px] w-full">
            ...
            <div className="flex flex-col gap-9 items-center justify-start w-full">
              <h1
                className="text-lg md:text-[22px] text-center font-dm-sans-medium text-gray-901 leading-8 w-auto"
              >
