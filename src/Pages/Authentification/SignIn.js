...
export default function SignIn() {
  ...
  */
  ...
  return (
    <>
    <div className=" bg-blue_gray-900_01 bg-[url(/public/images/Bg.png)] bg-no-repeat bg-center md:bg-right-top xl:bg-[size:cover,_auto]  2xl:bg-[size:cover,_contain] 2xl:bg-right-top flex flex-col  items-center justify-start mx-auto px-[12px] py-[30px] md:px-10 min-h-screen overflow-y-auto w-full">
              ...
              <div className="flex flex-col gap-4 items-center justify-start w-full">
                  ...
                  <div className="flex flex-col items-center justify-start w-full mt-[5px] ">
                    <div className={` my-3 flex flex-row gap-6 h-[52px] md:h-auto items-center justify-center py-[13px] rounded-[26px] w-full cursorpointer ${ loading ? 'bg-greenbtnhoverbg' : 'bg-teal-A700 hover:bg-greenbtnhoverbg  hover:svg-translate'}`} 
                      ...
                      <button ref={formButtonRef} type="submit" className={`text-base items-center justify-center font-dm-sans-medium text-white-A700 ${loading ? 'disabled' : ''} w-auto`}>
                      { loading? t("all.sending") : t('signin.signIn')}
                      </button>
                      {loading ? 
