...
export default function SignIn() {
  ...
  const errorSocial = searchParams.get('error') ? searchParams.get('error') : null;
  ...
  */
  ...
  return (
    <>
      ...
      <a href="#signin-title" className="skip-link sr-only focus:not-sr-only focus:absolute focus:top-0 focus:left-0 focus:bg-white focus:text-blue-900 focus:p-2 focus:z-50 focus:underline">{t('accessibility.skipToContent') || 'Aller au contenu principal'}</a>
      <section className=" bg-blue_gray-900_01 bg-[url(/public/images/Bg.png)] bg-no-repeat bg-center md:bg-right-top xl:bg-[size:cover,_auto]  2xl:bg-[size:cover,_contain] 2xl:bg-right-top flex flex-col items-center justify-start mx-auto min-h-screen overflow-y-auto w-full">
        <div style={{
          ...
          <section className="bg-white-A700 flex flex-col items-center justify-start px-6 py-8 rounded-xl shadow-formbs w-full max-w-[min(90%,400px)] sm:max-w-[440px] md:max-w-[480px] lg:max-w-[500px] xl:max-w-[520px]">
                ...
                <form autoComplete='off' onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-4 items-center justify-start w-full">
                  ...
                  <div className="flex flex-col gap-4 items-center justify-start w-full">
                    ...
                    <div className="flex flex-col gap-2 items-start justify-start w-full">
                      <div className="relative w-full">
                        ...
                        <button
                          ...
                          aria-label={showPassword ? (t('signin.hidePassword') || 'Masquer le mot de passe') : (t('signin.showPassword') || 'Afficher le mot de passe')}
                        >
                          {showPassword ? (
                    ...
                    <div className="flex flex-row gap-2.5 items-center justify-between  w-full">
                      ...
                      <span
                        className="cursorpointer text-[13px] hover:text-[#00CDAE] leading-[16.93px] font-dm-sans-regular text-deep_purple-A400 tracking-[0.01em] text-right"
                    ...
                    <div className="flex flex-col items-center justify-start w-full mt-[5px] ">
                      ...
                      <div className="flex flex-row gap-2.5 items-center justify-start w-auto mt-5">
                        ...
                        >
                          <span className="font-dm-sans-bold">{t('signin.createAccount')}</span>
                        </Link>
                      </div>
                    </div>
                  </div>
