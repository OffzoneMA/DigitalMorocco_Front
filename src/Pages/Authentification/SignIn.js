  ...
  */
  ...
  return (
    ...
    <div className=" bg-blue_gray-900_01 bg-[url(/public/images/Bg.png)] bg-no-repeat bg-center md:bg-right-top xl:bg-[size:cover,_auto]  2xl:bg-[size:cover,_contain] 2xl:bg-right-top flex flex-col items-center justify-start mx-auto min-h-screen overflow-y-auto w-full">
      <div className="flex-1 flex flex-col gap-8 md:gap-9 xl:gap-10 2xl:gap-11 items-center w-full justify-center p-4 md:p-6 lg:p-8 xl:p-10 2xl:p-12">
          ...
          <div className="bg-white-A700 flex flex-col items-center justify-start px-6 py-8 rounded-xl shadow-formbs w-full max-w-[min(90%,380px)] sm:max-w-[400px] md:max-w-[440px] lg:max-w-[480px] xl:max-w-[520px]">
