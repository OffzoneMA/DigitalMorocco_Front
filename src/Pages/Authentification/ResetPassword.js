...
export default function ResetPassword() {
  ...
  }, [isSuccess, isLoading, error , navigate]);
  ...
  return (
    <>
      ...
      />
      <section className="bg-gray-100 flex flex-col min-h-screen font-DmSans items-center justify-end mx-auto md:px-10 px-5 py-[20px] md:py-[42px] overflow-y-auto w-full">
