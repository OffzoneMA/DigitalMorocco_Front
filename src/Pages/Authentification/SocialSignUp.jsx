  ...
  return (
    <>
      <HelmetWrapper
        ...
        canonical={`${import.meta.env.VITE_URL}/SocialSignUp`}
      />
              ...
              >
                ...
                <div className="flex flex-col gap-4 items-center justify-start w-full">
                  <div className="flex flex-col gap-2 items-start justify-start w-full">
                    <Text className="text-gray-900_01 font-dm-sans-regular text-sm leading-[26px] text-left w-auto">
                      {t("signup.fullName")}
                    </Text>
                    <input
                      ...
                      className={`bg-white w-full leading-[18.23px] border border-solid !focus:border !focus:border-solid ${
                        errors?.displayName
                    ...
                    ></input>
                    {errors?.displayName &&
                      getValues("displayName")?.length > 0 && (
                    ...
                    <div className="flex flex-row items-start mt-4 justify-start w-full">
                      ...
                      >
                        <input
                          ...
                          type="checkbox"
                          name="acceptTerms"
                          className={`peer appearance-none w-[16px] h-[16px] bg-white_A700 checked:bg-blue-600 checked:border-blue-600 border-[0.5px] border-[#303030] ${
                            errors?.acceptTerms
                              ? "border-errorColor text-errorColor shadow-checkErrorbs"
                              : "shadow-none border-[#303030] "
                          } rounded-[4px] focus:ring-blue-500 relative`}
                        />
                        <svg
                          width="12"
                          height="9"
                      ...
                      >
                        {t("signup.terms1")}{" "}
                        <a
                          href="https://digitalmorocco.net/terms"
                          target="_blank"
                        ...
                        {t("signup.terms3")}{" "}
                        <a
                          href="https://digitalmorocco.net/privacy"
                          target="_blank"
                          className="text-[#2575F0] hover:text-[#00CDAE] cursorpointer"
                        >
