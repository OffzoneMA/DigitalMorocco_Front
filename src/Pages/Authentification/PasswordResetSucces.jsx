...
export default function PasswordResetSucces() {
  ...
  return (
    <>
      <HelmetWrapper
        title={t(`helmet.resetPassword.PasswordResetSucces.title`)}
        description={t(`helmet.resetPassword.PasswordResetSucces.description`)}
        keywords={t(`helmet.resetPassword.PasswordResetSucces.keywords`)}
        canonical={`${import.meta.env.VITE_URL}/PasswordResetSucces`}
      />
      <div className="bg-gray-100 flex flex-col font-DmSans items-center min-h-screen justify-start mx-auto md:py-[60px] md:px-10 px-3 py-[30px] overflow-y-auto w-full">
        <div className="flex flex-col gap-[42px] items-center justify-start mb-[213px] w-full">
          ...
          <div className="bg-white-A700 flex flex-col gap-9 items-center justify-start px-6 py-[42px] rounded-[12px] shadow-formbs max-w-[520px] w-full">
            <img className="h-[235px] w-64" src={succesImage} alt="succes" />
            <div className="flex flex-col gap-9 items-center justify-start w-full">
              <Text className="text-lg md:text-[22px] text-center font-dm-sans-medium text-gray-901 leading-8 w-auto">
                <>{t("resetSuccess.resetSuccess")}</>
              </Text>
              <div className="flex flex-col gap-6 items-center justify-start w-full">
                <div
                  className="bg-teal-A700 my-3 flex flex-row gap-6 h-[52px] md:h-auto items-center justify-center py-[14px] rounded-[26px] w-full cursorpointer hover:bg-greenbtnhoverbg hover:svg-translate"
