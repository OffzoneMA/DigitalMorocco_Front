...
export default function SocialSignUp() {
  ...
  return (
    <>
      ...
      />
      <section className="bg-gray-100 flex flex-col min-h-screen overflow-y-auto font-DmSans items-center justify-start mx-auto pt-[80px] md:px-10 px-[12px] py-[30px] w-full">
        <div className="flex flex-col gap-[42px] items-center justify-start mb-[63px] w-auto sm:w-full">
          ...
          <div className="flex flex-row gap-2.5 items-center justify-start w-auto">
            ...
            >
              <span className='cursorpointer'>{t('signup.signIn')}</span>
            </a>
          </div>
        </div>
