...
export default function VerificationCode() {
  ...
  return (
    <>
      ...
      />
      <section className="bg-gray-100 flex flex-col font-DmSans items-center justify-start mx-auto md:py-[60px] md:px-10 px-3 py-[30px] w-full min-h-screen overflow-y-auto">
        <div className="flex flex-col gap-[42px] items-center justify-start mb-[39px]  w-full">
          ...
          <div className="bg-white-A700 flex flex-col gap-9 items-center justify-start sm:px-5 px-8 py-[42px] rounded-[12px] shadow-bs1 max-w-[520px] w-full">
            ...
            <h1
              className="md:text-[22px] text-black-900 text-lg w-auto font-dm-sans-medium"
            >
              {t('verifyEmail')}
            </h1>
            <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-9 items-center justify-start w-full">
              <div className="flex flex-col items-center justify-start w-full">
                <p
                  className="leading-[26.00px] max-w-[456px] md:max-w-full text-base text-blue_gray-500 text-center font-dm-sans-medium"
                >
                  ...
                  <div className="flex sm:flex-row flex-col gap-6 items-start justify-between py-2 w-full">
                    ...
                    <div className="bg-blue-50 flex flex-row gap-6 h-[52px] md:h-auto w-full items-center justify-center sm:px-8 px-12 py-[13px] rounded-[26px] ">
                      <button
                        ...
                        className="text-teal-A700 leading-[normal] rounded-[26px] text-base text-center w-full gap-[10px]"
                        size="p-[15px]"
                      >
                        {isSendingOTP ?
                          <>
