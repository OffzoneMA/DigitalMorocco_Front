...
const ResendVerificationLink = () => {
  ...
  const [trigger, { isLoading }] = authApi.endpoints.sendEmailVerification.useLazyQuery()
  ...
  return (
    <>
      ...
      <section className={`bg-white-A700 flex flex-col font-DmSans gap-[50px] items-center justify-start mx-auto pb-[50px] w-full min-h-screen overflow-y-auto`}>
        <header className="border-b border-gray-201 border-solid flex flex-row md:flex-row gap-10 items-center justify-between pl-2 pr-12 md:px-[100px] py-5 w-full relative">
