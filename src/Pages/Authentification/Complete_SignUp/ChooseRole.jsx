...
const ChooseRole = () => {
  ...
  const [getUserDetails, { data, isSuccess, isError, error }] =
  ...
  //       axios.get(`${import.meta.env.VITE_baseURL}/users/userInfo`, {
  //           headers: {
  ...
  return (
    <>
      <HelmetWrapper
        ...
        canonical={`${import.meta.env.VITE_URL}/ChooseRole`}
      />
      <div
        className={`bg-white-A700 flex flex-col font-DmSans ${
          selectedGrid ? "gap-[20px]" : "gap-[84px]"
        } items-center justify-start mx-auto pb-[246px] w-full min-h-screen overflow-y-auto`}
      >
        <div className="border-b border-gray-201 border-solid flex flex-row md:flex-row gap-10 items-center justify-between px-20 pl-2 pr-12 md:px-[100px] py-5 w-full relative">
          <a href="https://digitalmorocco.net" target="_blank">
            <img className="h-[47px] w-[180px]" src={logo} alt="logo" />
          </a>
          <div
          ...
          >
            <button
              id="profileBtn"
              className="btnUserProfil cursorpointer relative"
            ...
            >
              ...
              >
                ...
                />
                <path
                  d="M11 28.7803C13.3358 26.3029 16.507 24.7803 20 24.7803C23.493 24.7803 26.6642 26.3029 29 28.7803M24.5 16.2803C24.5 18.7656 22.4853 20.7803 20 20.7803C17.5147 20.7803 15.5 18.7656 15.5 16.2803C15.5 13.795 17.5147 11.7803 20 11.7803C22.4853 11.7803 24.5 13.795 24.5 16.2803Z"
                  stroke="#303030"
                  strokeWidth="2"
                  strokeLinecap="round"
            ...
            {showLogout && (
              <div className="absolute top-[100%] right-0 w-[248px]">
                <button
                  className="cursorpointer-green bg-white-A700 text-blue_gray-904 flex flex-row gap-4 px-[18px] mt-[5px] border border-gray-201 w-[248px] rounded-[6px] h-[46px] items-center transition-colors duration-100 hover:text-[#EA6479] hover:stroke-red"
                  onClick={() => {
                    dispatch(logout());
                    navigate("/SignIn");
                  }}
                >
                  ...
                  <span className="flex items-center font-dm-sans-regular text-base leading-[26px] transition-colors duration-100">
                    {t("chooserole.signout")}
                  </span>
                </button>
              </div>
            )}
        ...
        {selectedGrid && (
          <div className="px-20 flex justify-end w-full h-[52px]">
            <button
              className={`cursorpointer leading-[20.83px] ml-auto my-3 max-w-[264px] flex flex-row gap-6 h-[52px] items-center justify-center px-[24px] py-[13px] rounded-[200px] w-auto ${
                response?.isLoading
                  ? "bg-greenbtnhoverbg"
                  : "bg-teal-A700 hover:bg-greenbtnhoverbg  hover:svg-translate"
              } hover:bg-greenbtnhoverbg hover:svg-translate`}
              onClick={confirmRole}
              type="button"
            >
              <span className="text-base items-center justify-center font-dm-sans-medium text-white-A700 w-auto">
                {isModalOpen
                  ? t("chooserole.confirmed.button1")
                  : response?.isLoading
                  ? t("all.sending")
                  : t("chooserole.confirmed.button")}
              </span>
              {!isModalOpen && (
                <svg
                  width="22"
        ...
        <div className="flex flex-col gap-[42px] items-center justify-start  px-[12px] m-auto w-full">
          <Text className="text-lg md:text-[22px] text-blue_gray-900 text-center font-dm-sans-medium leading-[32px] w-auto">
            {t("chooserole.welcomeMessage")}
          </Text>
          <div className="flex flex-col gap-[42px] items-center justify-start w-full">
            <div className="flex flex-col items-center justify-start w-full">
              <Text className="text-base text-blue_gray-500 font-dm-sans-medium  leading-[26px] text-center w-full">
            ...
            <div className="flex flex-col items-center w-full">
              <div className="flex items-center justify-center flex-wrap gap-10 w-full">
                <div
                  ...
                  className={`border-2 animation border-solid flex flex-col items-center justify-start md:px-10 px-3 py-[42px] rounded-[16px] w-[382.67px] cursorpointer-green hover:border-blue-503 hover:shadow-roleCardbs ${
                    selectedGrid == 1
                      ? "border-blue-503 shadow-roleCardbs"
                      : "border-gray-201"
                  }`}
                >
                  <div className="flex flex-col gap-5 md:gap-[22px] items-center justify-start w-auto">
                    <Text className="font-dm-sans-bold text-base leading-[26px] tracking-[2px]  text-center text-blue_gray-904 uppercase w-auto">
                    ...
                    <img
                      ...
                      alt="startup"
                    />
                    <Text className="leading-[26.00px] max-w-[257px]  font-dm-sans-regular text-center text-color2">
