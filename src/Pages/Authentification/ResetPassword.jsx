  ...
  return (
    <>
      <HelmetWrapper
        ...
        canonical={`${import.meta.env.VITE_URL}/ResetPassword`}
      />
      <div className="bg-gray-100 flex flex-col min-h-screen font-DmSans items-center justify-end mx-auto md:px-10 px-5 py-[20px] md:py-[42px] overflow-y-auto w-full">
        <div className="flex flex-col gap-[42px] items-center justify-start mt-[27px] md:px-5 w-full">
          ...
          <div className="bg-white-A700 flex flex-col gap-9 items-center justify-start px-8 py-[42px] rounded-[12px] shadow-formbs max-w-[520px] w-full">
            ...
            <Text className="md:text-[22px] text-lg font-dm-sans-medium text-gray-901 leading-8 w-auto">
            ...
            >
              <div className="flex flex-col gap-6 items-center justify-start w-full">
                <Text className="leading-[28.00px] w-full font-dm-sans-medium text-left text-gray-901 text-lg ">
                  {t("resetPassword.enterNewPassword")}
                </Text>
                <div className="flex flex-col gap-2 items-start justify-start w-full">
                  <Text className="text-gray-901 font-dm-sans-medium text-base leading-[26px] text-left w-auto">
                  ...
                  <div className="relative w-full">
                    <input
                      ...
                      } placeholder:tracking-normal bg-white w-full border border-solid ${
                        errors?.password
                          ? "border-errorColor focus:border-errorColor shadow-inputBsError"
                          : "border-borderColor focus:border-focusColor focus:shadow-inputBs"
                      } rounded-full px-[18px] py-[12px] placeholder:text-placehColor font-dm-sans-regular placeholder:text-[14px] text-[15px] text-${
                ...
                <div className="flex flex-col gap-2 items-start justify-start w-full">
                  ...
                  <div className={`relative w-full`}>
                    <input
                      ...
                      className={`${
                        !showConfPassword ? "tracking-[0.32em]" : ""
                      } placeholder:tracking-normal bg-white w-full border border-solid ${
                        errors?.confirmPassword
                          ? "border-errorColor focus:border-errorColor shadow-inputBsError "
                          : "border-borderColor focus:border-focusColor focus:shadow-inputBs"
                      } rounded-full px-[18px] py-[12px] placeholder-text-placehColor font-dm-sans-regular placeholder:text-[14px] text-[15px] text-${
                        errors?.confirmPassword ? "errorColor" : "gray-801"
                      }`}
                    ></input>
                    <button
                      type="button"
              ...
              <div className="flex flex-col gap-4 items-center justify-start w-full">
                <div
                  className={` my-3 flex flex-row gap-6 h-[52px] md:h-auto items-center justify-center py-[14px] rounded-[26px] w-full cursorpointer ${
                    isLoading
                      ? "bg-greenbtnhoverbg"
