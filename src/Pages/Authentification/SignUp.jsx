...
export default function SignUp() {
  ...
  const [trigger, { data, isLoading, status, isSuccess, error: triggerError }] =
  ...
  return (
    <>
      <HelmetWrapper
        ...
        canonical={`${import.meta.env.VITE_URL}/SignUp`}
      />
      <div className="bg-gray-100 flex flex-col font-DmSans items-center justify-start mx-auto min-h-screen overflow-y-auto md:px-10 px-[12px] py-[30px] w-full">
        <div className="flex flex-col gap-[42px] items-center justify-start mb-[63px] w-auto sm:w-full">
          ...
          <div className="bg-white-A700 shadow-formbs gap-5 md:gap-10 flex flex-col items-center justify-start px-6 py-8 rounded-[12px] w-full max-w-[520px]">
            <div className="flex flex-col gap-4 items-center justify-start w-full">
              ...
              <form
                ...
                className="flex flex-col gap-5 items-center justify-start w-full"
              >
                <Text className="text-base font-dm-sans-medium leading-[25.6px] text-gray-901 tracking-[0.16px] w-auto">
                ...
                <div className="flex flex-col gap-4 items-center justify-start w-full">
                  <div className="flex flex-col gap-2 items-start justify-start w-full">
                    ...
                    <input
                      ...
                      className={`bg-white w-full  border border-solid !focus:border !focus:border-solid ${
                        errors?.displayName
                      ...
                      } placeholder:text-placehColor font-dm-sans-regular placeholder:text-[14px] text-[15px] text-${
                        errors?.displayName ? "errorColor" : "gray-801"
                      }`}
                      type="text"
                    ></input>
                  ...
                  <div className="flex flex-col gap-2 items-start justify-start w-full">
                    ...
                    <input
                      ...
                      className={`bg-white w-full border border-solid !focus:border !focus:border-solid ${
                        ...
                        errors?.email ? "errorColor" : "gray-801"
                      }`}
                      type="text"
                    ></input>
                    {errors?.email?.message && getValues("email") !== "" && (
                      <span className="text-errorColor font-dm-sans-regular text-sm">
                  ...
                  <div className="flex flex-col gap-3 items-end justify-start w-full">
                    <div className="flex flex-col gap-2 items-start justify-start w-full">
                      ...
                      <div className="relative w-full">
                        <input
                          ...
                          className={`${
                            ...
                            errors?.password ? "errorColor" : "gray-801"
                          }`}
                        />
                      ...
                      {!errors?.password && getValues("password") == "" && (
                        <span className="font-dm-sans-regular mt-1 text-xs leading-[15.62px] tracking-[0.01em] text-left text-[#555458]">
                  ...
                  <div className="flex flex-col mt-1 mb-1 gap-2.5 items-start justify-start w-full">
                    <Text className="font-Avenir-next-LTPro leading-[16.8px] text-[12px] text-[#585E66] w-full">
                      {t("signup.accordance")} <br />
                      {t("signup.accordance1")}{" "}
                    ...
                    <div className="flex flex-row items-start justify-start m-auto w-full mt-4">
                      ...
                      >
                        <input
                          ...
                          type="checkbox"
                          name="acceptTerms"
                          className={`peer appearance-none w-[16px] h-[16px] bg-white_A700 checked:bg-blue-600 checked:border-blue-600 checked:shadow-none border-[0.5px]  ${
                            errors?.acceptTerms?.message && sending
                      ...
                      >
                        ...
                        >
                          <span>{t("signup.terms2")}</span>
                        </a>{" "}
                        {t("signup.terms3")}{" "}
                        <a
                          href={`https://digitalmorocco.net/privacy?lang=${currentLanguage}`}
                          target="_blank"
                          className="text-[#2575F0] hover:text-[#00CDAE] cursorpointer"
                        >
                          <span>{t("signup.terms4")}</span>
                        </a>{" "}
                        {t("signup.terms5")}
                      </label>
                    </div>
                  ...
                  <div
                    className={`my-3 flex flex-row gap-6 h-[52px] md:h-auto items-center justify-center py-[13px] rounded-[26px] w-full cursorpointer ${
                      loading
                        ? "bg-greenbtnhoverbg"
                        : "bg-teal-A700 hover:bg-greenbtnhoverbg  hover:svg-translate"
                    } `}
              ...
              <div className="flex sm:flex-row flex-row gap-2.5 items-center justify-start py-2.5 w-full">
                ...
                <Text className="text-[15px] font-dm-sans-medium leading-[19.53px] text-gray700 tracking-[0.15px] w-auto">
                  {t("signup.or")}
                </Text>
                <div className="bg-gray-300 h-px w-[46%]" />
              </div>
              <div className="flex flex-col gap-3 items-center justify-start w-full">
                <Text className="text-base font-dm-sans-medium leading-[25.6px] tracking-[0.01em] text-gray-901 w-auto">
                ...
                <div className="flex flex-col gap-3 items-center justify-start w-full">
                  ...
                  >
                    <div
                      className={`${
                        currentLanguage === "fr" ? "w-[196px] " : "w-[143px]"
                      } font-dm-sans-medium  leading-[18.23px] text-left text-[14px] tracking-[0.14px]`}
                    >
                  ...
                  <Button
                    ...
                    leftIcon={
                      <img className="h-6 mr-2.5" src={linkLogo} alt="link" />
                    }
                    shape="round"
                  >
                    <div
          ...
          <div className="flex flex-row gap-2.5 items-center justify-start w-auto">
            <a className="text-[#37363B] text-sm font-dm-sans-medium leading-[26px]  w-auto">
