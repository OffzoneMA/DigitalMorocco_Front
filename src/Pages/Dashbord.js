                                ...
                                <tr key={index} className={`${index % 2 === 0 ? 'bg-gray-50' : ''} w-full`}>
                                  <td className="py-4 px-3 w-auto text-gray-600 text-sm font-dm-sans-regular leading-6">
                                    <div className="flex items-center">
                                      <img src={item?.image} className="rounded-full h-8 w-8 bg-gray-300 mr-2"  alt={""}/>
                                      <span style={{ overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>{item?.investor?.name}</span>
                                    </div>
                                  </td>
