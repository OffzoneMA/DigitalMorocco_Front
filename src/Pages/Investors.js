          ...
          <div className="flex flex-col items-start justify-start sm:px-5 px-8 w-full">
            <div className="w-full bg-white-A700 border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
              <div className="flex flex-row text-sm text-center text-gray-500 border-b border-gray-200 rounded-t-lg bg-white-A700 dark:border-gray-700 dark:text-gray-400 dark:bg-gray-800 py-4 px-5">
                ...
                (
                    <>
                    <div className="flex rounded-md p-1.5 border border-solid min-w-[80px]">
                      <input
                    ...
                    <CheckPicker size="md" data={invTypedata}
                                className="cus_pop !placeholder:text-blue_gray-300 !text-gray700 font-manrope font-normal leading-18 tracking-wide"
                                placeholder="Type of Investment"
                                menuClassName="cus_pop"
                                />
                    <SelectPicker size="md" data={dataCountries}
                                labelKey="name" valueKey="name"
                                className=" !placeholder:text-blue_gray-300 !text-gray700 font-manrope font-normal leading-18 tracking-wide"
                                menuClassName="cus_pop"
                  ...
                  <tbody className="items-center w-full ">
                   {
                    ...
                    <tr key={index} className={`${index % 2 === 0 ? 'bg-gray-50' : ''} hover:bg-blue-50 w-full`} onClick={()=> navigate("/InvestorDetails")}>
                    <td className="w-auto text-gray-600 font-DmSans text-sm font-normal leading-6">
