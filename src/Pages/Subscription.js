          ...
          <div className="flex flex-col md:flex-row items-start py-6 w-full h-full md:min-h-[540px] gap-8">
            <div className="flex flex-col md:border-r border-indigo-50 pr-8 md:flex-1 lg:flex-1 gap-4">
              ...
              <div className="flex flex-col w-full rounded-[12px] border p-4 border-gray-301 gap-4">
                ...
                <div className="flex space-x-3 md:space-x-5 items-end w-full border-b pb-6 border-gray-301 py-2 justify-end">
                  <button
                ...
                <div className="flex flex-col w-full border-b pb-4 border-gray-301 gap-4">
                  ...
                  <div className="flex flex-col w-full rounded-[12px] border p-4 border-gray-301 gap-3">
                    <div className="flex flex-row w-full items-center pb-1">
                      ...
                      <div className='flex flex-row gap-[18px] ml-auto'>
                        <button
                          onClick={() => setAnnualPlan(false)}
                          className={`${!anuualPlan ? "bg-blue-A400 text-white-A700": "bg-white-A700 text-blue-A400 border border-blue-A400"} font-DmSans flex flex-row h-11 items-center gap-3 py-2 px-8 rounded-md w-auto`}
                          type="button"
                        >
                          <span className="text-base leading-[20.83px] font-medium">
                          Monthly
                        ...
                        <div className='flex flex-col gap-1'>
                          <button
                            ...
                            className={`${anuualPlan ? "bg-blue-A400 text-white-A700": "bg-white-A700 text-blue-A400"} h-11 font-DmSans border border-blue-A400 flex flex-row items-center gap-3 py-2 px-8 rounded-md w-auto`}
                            type="button"
                          >
                            <span className="text-base leading-[20.83px] font-medium">
                            Annual
                          ...
                          <div className="w-auto flex h-6 px-2.5 py-0.5 bg-[#E1FFED] rounded-md border ml-auto justify-end items-center">
                              <div className="text-center text-[#00CDAE] text-[10px] font-dm-sans-bold leading-normal">Save up to 40%</div>
                          </div>
                        </div>
                      </div>
                    </div>
                    {['Access essential features to kickstart your startup journey.', 'Limited Event Participation', 'Browse a curated list of investors and view their profiles', 'Initiate contact with investors by sending them requests.'].map((feature, index) => (
                      <div key={index} className="flex flex-row w-full items-start gap-2">
                        <div className="flex flex-col w-6 h-6 items-center justify-center bg-[#EDF7FF] rounded-full">
                        <svg width="13" height="11" viewBox="0 0 13 11" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <path fill-rule="evenodd" clip-rule="evenodd" d="M11.098 0.390159L3.93797 7.30016L2.03797 5.27016C1.68797 4.94016 1.13797 4.92016 0.737968 5.20016C0.347968 5.49016 0.237968 6.00016 0.477968 6.41016L2.72797 10.0702C2.94797 10.4102 3.32797 10.6202 3.75797 10.6202C4.16797 10.6202 4.55797 10.4102 4.77797 10.0702C5.13797 9.60016 12.008 1.41016 12.008 1.41016C12.908 0.490159 11.818 -0.31984 11.098 0.38016V0.390159Z" fill="#00CDAE"/>
                        </svg>
                        </div>
                    ...
                    {anuualPlan ? 
                      <Text className="font-DmSans text-lg font-medium leading-8 pt-1 text-left w-full text-gray-801">
                      <span className="text-[#98A1B2] text-base font-dm-sans-medium line-through leading-loose">$99.9</span> $89.9, ends on May 17, 2025 
                      <div className="w-auto ml-6 h-6 px-2.5 py-0.5 bg-[#E1FFED] rounded-md border justify-center items-center inline-flex">
                        <div className="text-center text-[#00CDAE] text-[10px] font-dm-sans-bold leading-normal">20% off</div>
                      </div>
                    </Text>
                    :
                    <Text className="font-DmSans text-lg font-medium leading-8 pt-1 text-left w-full text-gray-801">
